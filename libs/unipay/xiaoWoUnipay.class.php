...
class App {
    //沃商店CPID
    public static $CPID = "86005064";
    
    //计费密钥
    public static $KEY = "30235b7b3a6bf005d284";
    
    //沃商店应用id
    public static $APP_ID = "903865228220160918152203332100";
    
    //应用名称
    public static $APP_NAME = "小沃学堂";
    
    //开发者名称
    public static $APP_DEVELOPER = "拓维信息系统股份有限公司";
    
    //渠道号
    public static $CHANNEL_ID = "9038652282";
}
