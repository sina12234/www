		...
		'<div class="plupload_wrapper">' +
			'<div class="ui-widget-content plupload_container">' +
				...
				'<div class="plupload_content">' +
					'<div class="plupload_droptext">' + _("也可以将文件拖到这里(文件最大8M，支持jpg,png,gif格式)") + '</div>' +
				...
				'<tr>' +
					'<td class="plupload_cell plupload_file_name">' +
						'<div class="plupload_buttons"><!-- Visible -->' +
							'<a class="plupload_button plupload_add">' + _("添加图片") + '</a>&nbsp;' +
	...
	*/
	...
	_handleState: function() {
		...
		if (up.total.queued === 0) {
			$('.ui-button-text', this.browse_button).html(_('添加图片'));
		} else {
			$('.ui-button-text', this.browse_button).html(o.sprintf(_('继续添加'), up.total.queued));
		}
