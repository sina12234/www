...
function textResponse(data){
	...
	if(data.is_teacher){
	//	dom = '<div title="'+data.last_updated+'" class="dhk1" user_id="' + u + '"><span><img src="' + thumb + '" width="24" height="24"></span><div class="jjj"></div><div class="mess"><p>老师说:<b c>' + a + '</b></p></div></div>';
...
function goodResponseLater2(data){
	...
	if(u in _info && !_info[u]["free"]){
		...
		//	var good = $('<div><div class="Ranking-p" uid="'+u+'"><p good2 class="dy">'+(_goodNum+1)+'</p><p><img good width="46" height="46" src="'+o.thumb+'"></p><p class="dy1" good>'+o.name+'</p><p class="dz"><b good>1</b>次</p></div><div class="clear"></div></div>');
			var	good = $('<div class="dznav pd5 col-sm-6 col-xs-12" uid="'+u+'"><div class="col-sm-4 col-xs-4 jk"><p good2>'+(_goodNum+1)+'</p></div><div class="col-sm-4 col-xs-4"><p class="limithis">'+o.name+'</p></div><div class="col-sm-4 col-xs-4 se"><p>点赞<b good>1</b>次</p></div>');
			/*if(_goodNum){
...
function setOnlineNum2(num){
	if(1 != fee_type){
		$("#tourist_total").find("b[inline]").text(num);
	}
}
