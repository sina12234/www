...
(function ($, window, document, undefined)
{
    ...
    //添加到jquery
    $.fn.regform = function (options)
    {
        var validation = new _regform(this, options);
...
(function ($, window, document, undefined)
{
    ...
    _easyinput.prototype = {
        ...
        init: function ()
        {
            ...
            //是否实时检查
            var easyinput = this;
            var rule = this.input.attr("regform");
        ...
        validation: function ()
        {
            ...
            this.rule = this.input.attr("regform");
        ...
        judge: {
            ...
            "mob": function (ei, v, p)
            {
                if (false == /^0?1[3|4|5|7|8][0-9]\d{8}$/.test(v))
                    return ei._error("mob");
                else
                    return ei._success_rule("mob");
            },
