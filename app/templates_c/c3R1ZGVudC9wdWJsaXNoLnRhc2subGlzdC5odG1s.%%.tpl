...
<div class="g-nav hidden-lg hidden-md">
    <ul class="swiper-wrapper" id="mob-nav">
        ...
        <li class="swiper-slide"><a href="/task.commitTask.studentTaskListShow" class="selected">我的作业</a></li>
                            ...
                            <div class="first-zoom">
                                ...
                                <ul class="zoom-list zoom-down">
                                    ...
                                    <li class="col-md-20 p0">
                                        ...
                                        <div class="co-md-20 zoom-info zoom-down clearfix" data-taskId="<%= p%>" >
                                            <!-- lt -->
                                            <div class="col-md-3 zoom-info-time col-xs-7">
                                            ...
                                            <!-- /lt -->
                                            <!-- rt -->
                                            <div class="col-md-17 zoom-info-course p10 clearfix col-xs-13" style="border-left: 1px solid #ccc;">
                                                <div class="row">
                                                <div class="col-md-6">
                                ...
                                for (var j in monthData) {
                                    ...
                                    if(num == 0){
                                        ...
                                        for (var p in workData) {
                                            ...
                                            dataHtml.find('.zoom-info').append('<div class="col-md-3 zoom-info-time col-xs-7"><p>'+workData[p].create_time_month+'</p><p class="cGray">'+workData[p].create_time_time+'</p><span class="zoom-info-icon"></span></div>');
                                            dataHtml.find('.zoom-info').append('<div class="col-md-17 zoom-info-course p10 clearfix col-xs-13"><div class="col-md-6"><p class="ellipsis">'+workData[p].courseName+' '+workData[p].className+'</p></div><div class="col-md-9 workData-desc"></div><div class="col-md-5 zoom-info-action"></div</div>');
                                            if(workData[p].teacher_name != '' ){
