...
<head>
	...
	<title>设置课程图片 - <?php echo tpl_function_part('/site.main.orgname'); ?> - 云课 - 专业的在线学习平台</title>
    ...
    <link rel="stylesheet" type="text/css" href="<?php echo utility_cdn::js('/assets/js/jcrop/css/jquery.Jcrop.css'); ?>">
</head>
<style type="text/css">
					...
					<section class="col-md-20 fs14 base-content clearfix">
						...
						<div class="c-fl ml20 mr20">
							<div class="set-course-Info-lt mb10">
								...
								<img src="<?php echo SlightPHP\Tpl::$_tpl_vars["courseInfo"]['thumbBig']; ?>" id="element_id" class="hidden" alt="">
								<div id="progress" style="display:none;"></div>
							</div>
							<div class="set-course-bigImg" style="display:none;">
								<img id="img_o" src="<?php echo SlightPHP\Tpl::$_tpl_vars["courseInfo"]['thumbMed']; ?>" alt="" />
							</div>
						...
						<div class="c-fl set-course-Info-mt">
							...
							<div class="set-course-Info-rt" id="panel">
								<img id="desc_img" src="<?php echo SlightPHP\Tpl::$_tpl_vars["courseInfo"]['thumbMed']; ?>" width="260" height="160" alt="" />
								<span class="course-big-img"></span>
							</div>
						</div>
...
<input class="hidden" courseId="<?php echo SlightPHP\Tpl::$_tpl_vars["courseId"]; ?>" id="grobal-course" />
</body>
</html>
<script type="text/javascript" src="<?php echo utility_cdn::js('/assets_v2/js/plupload.full.min.js'); ?>"></script>
...
var userId   = <?php echo SlightPHP\Tpl::$_tpl_vars["userId"]; ?>;
...
$(function(){
    ...
    var uploader = new plupload.Uploader({
        ...
        url: '/file.main.uploadCoursePicV2.<?php echo SlightPHP\Tpl::$_tpl_vars["userId"]; ?>',
        filters: {
            mime_types : [
