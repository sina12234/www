                  ...
                  <div class="clearfix">
                    ...
                    <div class="col-md-9 col-xs-20  col-sm-9 col-lg-11 oltcon">
                      ...
                      <div class="col-sm-12 col-xs-10 c-fl oltctxt fsellip">
						  <a href="<?php echo SlightPHP\Tpl::$_tpl_vars["o"]->course['url']; ?>">
							...
							<div>
								<?php if(!empty(SlightPHP\Tpl::$_tpl_vars["o"]->course['className'])){; ?>
									<p><?php echo tpl_modifier_tr(SlightPHP\Tpl::$_tpl_vars["o"]->course['className'],'site.index'); ?></p>
								<?php }; ?>
								<?php if(!empty(SlightPHP\Tpl::$_tpl_vars["o"]->course['teacherName'])){; ?>
									<p><?php echo SlightPHP\Tpl::$_tpl_vars["o"]->course['teacherName']; ?></p>
								<?php }; ?>
							</div>
					  	...
					  	<!-- 订单来源-->
						<a href="<?php echo SlightPHP\Tpl::$_tpl_vars["o"]->domainUrl[0]; ?>" target="_blank" class="c-fl col-lg-10">
                    ...
                    <div class="col-lg-2 col-sm-3 col-md-2 tac col-xs-20 oltcon col-sm-6 oltcon-status">
						<?php if(!empty(SlightPHP\Tpl::$_tpl_vars["o"]->price)){; ?>
							...
							<?php }elseif( (SlightPHP\Tpl::$_tpl_vars["o"]->price_old == SlightPHP\Tpl::$_tpl_vars["o"]->price)){; ?>
								<p class="cRed">￥<?php echo SlightPHP\Tpl::$_tpl_vars["o"]->price; ?></p>
							<?php }else{; ?>
								<p class="cGray fs_dsc hidden-xs">￥<?php echo SlightPHP\Tpl::$_tpl_vars["o"]->price_old; ?></p>
								<p class="cRed">￥<?php echo SlightPHP\Tpl::$_tpl_vars["o"]->price; ?></p>
							<?php }; ?>
					...
					<?php }; ?>
					  <?php if(SlightPHP\Tpl::$_tpl_vars["o"]->status == 'initial'){; ?>
                    	<div class="col-xs-20 oltcon col-sm-5 col-lg-4 tac">
							...
							<?php }; ?>
                      		<button class="btn mt40"><?php echo tpl_modifier_tr('立即支付','LearningCenter'); ?></button>
                      		</a>
                      		<p class="lh14 col-xs-10 col-sm-20 mt10"><a href="javascript:;" class="cancel" order_id="<?php echo SlightPHP\Tpl::$_tpl_vars["o"]->fk_order; ?>"><?php echo tpl_modifier_tr('取消订单','LearningCenter'); ?></a></p>
                    	</div>
					  <?php }; ?>
