...
<div class="notfound pd40">
    <div class="noting not-find">
        <div class="text">
            <img src="<?php echo utility_cdn::img('/assets_v2/img/404-title.png'); ?>" class="topimg" alt="" >
            <div class="jump">
                <span id="jumpTo">5</span>秒后<a id="jumpUrl" href="<?php echo SlightPHP\Tpl::$_tpl_vars["subdomain"]; ?>">返回首页</a>
            </div>
        </div>
        <img src="<?php echo utility_cdn::img('/assets_v2/img/404.png'); ?>" alt="" style="width: 100%;">
    </div>
