                ...
                <div class="content">
                    <div class="t-list-order fs14 col-md-20 pd0">
                        <form action='/org/student/list' method="POST">
							...
							<div class="col-md-20" style="float:right;padding:0;">
								...
								<a id="importStudent" class="c-fr blue-link"><?php echo tpl_modifier_tr('导出Excel','org'); ?></a>
							</div>
                        </form>
                    </div>
                    <table class="table-grid">
                        ...
                        <tr>
                            ...
                            <?php if(empty(SlightPHP\Tpl::$_tpl_vars["v"]['real_name'])){; ?>
                            <td class="name col-sm-2 col-md-3 tal">&nbsp;</td>
                            <?php }else{; ?>
                            <td class="name col-sm-2 col-md-3 tal" style="padding:0 10px;">
                                <a href="/org/student/detail/<?php echo SlightPHP\Tpl::$_tpl_vars["v"]['id']; ?>" class="blue-link"><?php if(SlightPHP\Tpl::$_tpl_vars["v"]['thumb']){; ?><img src="<?php echo utility_cdn::file(SlightPHP\Tpl::$_tpl_vars["v"]['thumb']); ?>" class="face"><?php }; ?>
                                <?php echo SlightPHP\Tpl::$_tpl_vars["v"]['real_name']; ?></a>
                            </td>
                            <?php }; ?>
                            <?php if(empty(SlightPHP\Tpl::$_tpl_vars["v"]['name'])){; ?>
                            <td class="col-sm-1 col-md-2">&nbsp;</td>
                            <?php }else{; ?>
                            <td class="col-sm-1 col-md-2"><?php echo SlightPHP\Tpl::$_tpl_vars["v"]['name']; ?></td>
                            <?php }; ?>
                            <?php if(empty(SlightPHP\Tpl::$_tpl_vars["v"]['gender'])){; ?>
                            <td class="col-sm-1 col-md-2">&nbsp;</td>
                            <?php }else{; ?>
                            <td class="col-sm-1 col-md-2"><?php echo tpl_modifier_tr(SlightPHP\Tpl::$_tpl_vars["v"]['gender'],'org'); ?></td>
                            <?php }; ?>
                            <?php if(empty(SlightPHP\Tpl::$_tpl_vars["v"]['school'])){; ?>
                            <td class="col-sm-3 col-md-5">&nbsp;</td>
                            <?php }else{; ?>
                            <td class="col-sm-3 col-md-5"><?php echo SlightPHP\Tpl::$_tpl_vars["v"]['school']; ?></td>
                            <?php }; ?>
                            <?php if(empty(SlightPHP\Tpl::$_tpl_vars["v"]['mobile'])){; ?>
                            <td class="col-sm-3 col-md-4">&nbsp;</td>
                            <?php }else{; ?>
					...
					<div class="col-sm-20 mt15 fs14 tac" style="padding-top:60px;display:block;">
