                    ...
                    <script type="template" id="image-box">
                        <% var type = type ? type : '' ; if( type == 'update') { imgUrl.forEach(function(item){ %>
                            <div class="image-box result-box left <%= className%>">
                                ...
                                <img src="<%= item.src_mall%>" data-width="<%= item.small_width%>" data-height="<%= item.small_height%>" alt="">
                            </div>
                            <% })  } else {  %>
                                <div class="image-box result-box left <%= className%>">
                                    <div class="clear-icon"></div>
                                    ...
                                    <img src="<%= imgUrl.src_small%>" alt="" data-width="<%= imgUrl.small_width%>" data-height="<%= imgUrl.small_height%>">
                                </div>
                                <% } %>
                    </script>
                ...
                <div class="task-action col-lg-15 col-md-15 col-sm-15 col-xs-20">
                    ...
                    <div class="dropdown-tips" id="dropdown-tips">
                        <div class="tips pl20">
                            ...
                            <div class="tips-text">最多输入5个知识点，用空格区分</div>
                        </div>
                    </div>
                </div>
                <div class="clear"></div>
