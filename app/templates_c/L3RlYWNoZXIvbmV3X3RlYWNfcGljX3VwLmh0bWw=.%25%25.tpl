...
<head>
    ...
    <title><?php if(!empty(SlightPHP\Tpl::$_tpl_vars["teacherInfo"]->real_name)){; ?><?php echo SlightPHP\Tpl::$_tpl_vars["teacherInfo"]->real_name; ?><?php }; ?> - <?php echo tpl_function_part('/site.main.orgname'); ?> - 云课 - 专业的在线学习平台</title>
...
<article class="th_pic_new container pd40">
    <ul class="col-md-20  th_picUp mt20 col-xs-20">
        <li class="col-md-4 upPic col-xs-10"><a href="javascript:;"><img style="height: 142px;" src="<?php echo utility_cdn::img('/assets_v2/img/up_pic.jpg'); ?>" alt=""/></a></li>
        <?php if(!empty(SlightPHP\Tpl::$_tpl_vars["list"])){; ?>
        <?php foreach(SlightPHP\Tpl::$_tpl_vars["list"] as SlightPHP\Tpl::$_tpl_vars["v"]){; ?>
        <li name="upImg" class="col-md-4 col-xs-10" data-id="<?php echo SlightPHP\Tpl::$_tpl_vars["v"]['imgId']; ?>" tid="<?php echo SlightPHP\Tpl::$_tpl_vars["tid"]; ?>" imgId="<?php echo SlightPHP\Tpl::$_tpl_vars["v"]['imgId']; ?>" >
            <em  class=" icon_pic"></em>
            <a href="/teacher/detail/imgInfo/<?php echo SlightPHP\Tpl::$_tpl_vars["tid"]; ?>/<?php echo SlightPHP\Tpl::$_tpl_vars["v"]['imgId']; ?>">
