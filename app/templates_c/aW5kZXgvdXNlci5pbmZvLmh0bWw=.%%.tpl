          ...
          <div class="right-content mainCon">
            <ul class="form fs14 mt40 wrap-form-select wrap-error-tip">
              <?php /*  <li class="pd-b20 row">
                ...
                <li class="item_nickname">
                  <div class="label col-lg-4 col-md-5 col-xs-7 col-sm-4" style="text-align:right;"><em class="red">*</em> 昵称：</div>
                  <div class="label-for col-lg-15 col-xs-13 col-md-15 row" >
                    <input type="text" id="nickname"  name="name" placeholder="最多15个字符" class="col-sm-10 col-lg-5 col-md-10 col-xs-20" value="<?php echo SlightPHP\Tpl::$_tpl_vars["userinfo"]->name; ?>">
					<span class="tip1 cRed"></span>
                  </div>
				</li>
                <li class="realname">
                  <div class="label col-lg-4 col-md-5 col-xs-7 col-sm-4" style="text-align:right;"><em class="red">*</em> 真实姓名：</div>
                  <div class="label-for col-lg-15 col-xs-13 col-md-15 row">
                ...
                <li>
                  <div class="label col-lg-4 col-md-5 col-xs-7 col-sm-4" style="text-align:right;"><em class="red">*</em> 性别：</div>
                  <div class="label-for col-lg-16 col-xs-13 col-md-15 row">
                ...
                <li>
                  <div class="label col-lg-4 col-md-5 col-xs-7 col-sm-4" style="text-align:right;">出生日期：</div>
                  <div class="label-for col-lg-16  col-xs-13 col-md-15 col-sm-16 row" id="birthday" >
                ...
                <li>
                  <div class="label col-lg-4 col-md-5 col-sm-4 col-xs-7" style="text-align:right;"><em class="red">*</em> 常住地区：</div>
                  <div class="label-for col-lg-16 col-xs-13 col-md-15 col-sm-16 row">
                    <select name="region_level0" id="level0" class="col-sm-3 col-xs-5">
                    ...
                    <select name="region_level1" id="level1" class="col-sm-3 col-xs-6">
                      <option value="">请选择</option>
                    </select>
					<select style="display:none" class="col-sm-3 col-xs-6" name="region_level2" id="level2">
					  <option value="">请选择</option>
					</select>
                ...
                <li>
                  <div class="label col-lg-4 col-md-5 col-sm-4 col-xs-7" style="text-align:right;"><em class="red">*</em> 教育阶段：</div>
                  <div class="label-for col-lg-16 col-xs-13 col-md-15 col-sm-16s row">
                    ...
                    <select name="school_id" id="school" class="col-sm-3 col-xs-6">
                      <option value="">学校</option>
                    </select>
                    <select name="grade" id="school_grade" class="col-sm-3 col-xs-6">
                      <option value="">年级</option>
                    </select>
					<span id='grades1' class="cRed c-fl"></span>
                  </div>
					<p class="new-cGray clear col-xs-20 c-fl col-md-offset-4 col-xs-offset-1 col-lg-offset-0" style="padding:0 0 0 180px;">如果没有您的学校,请<a class="cYellow" href="/index.about">联系我们</a>添加</p>
				</li>
                <li class="item_6" style="padding-bottom:20px;">
                  <div class="label col-lg-4 col-md-5 text-right col-sm-4 col-xs-20" style="padding-left:15px;"><em class="red"></em> 一句话简介：</div>
                  <div class="label-for col-lg-15 col-md-15 col-xs-20 col-sm-15 row">
				  <input type="text" class="col-sm-7 col-xs-20"  id="brief_desc" name="brief_desc" value="<?php if(SlightPHP\Tpl::$_tpl_vars["isTeacher"]=='1'){; ?><?php if(!empty(SlightPHP\Tpl::$_tpl_vars["teacher"]->brief_desc)){; ?><?php echo SlightPHP\Tpl::$_tpl_vars["teacher"]->brief_desc; ?><?php }; ?><?php }else{; ?><?php echo SlightPHP\Tpl::$_tpl_vars["userinfo"]->profile->desc; ?><?php }; ?>">&nbsp;&nbsp;
				...
				<li>
                    <div class="label col-lg-4 col-md-4 col-sm-3 col-xs-7 text-right" style="text-align: right;"><img src="<?php echo utility_cdn::img('/assets_v2/img/platform/x.png'); ?>">毕业院校：</div>
                ...
                <li class="pd-b10">
                     <div class="label col-lg-4 col-md-4 col-sm-3 col-xs-7" style="text-align: right;">学历：</div>
                    <div class="label-for col-lg-16 col-md-16 col-sm-17 col-xs-13 row">
				...
				<li>
					<div class="label col-lg-4 col-md-4 col-sm-3 col-xs-7 text-right" style="text-align: right;"><img src="<?php echo utility_cdn::img('/assets_v2/img/platform/x.png'); ?>">教龄：</div>
				...
				<li class="item_1" id="class-status">
					<div class="label col-sm-3 col-xs-7 col-md-4 col-lg-4 text-right" style="text-align: right;"><img src="<?php echo utility_cdn::img('/assets_v2/img/x.png'); ?>">教学阶段：</div>
					<div class="label-for col-sm-10 col-xs-13 col-lg-16 row">
						<label for="s1"><input type="checkbox" name="scopes[]" id="s1" value="preschool" <?php if(!empty(SlightPHP\Tpl::$_tpl_vars["teacher"]->scopes)&&in_array('preschool',SlightPHP\Tpl::$_tpl_vars["teacher"]->scopes)){; ?>checked<?php }; ?> id="s1">&nbsp;学前</label>
				...
				<li class="item_2">
					...
					<?php if(!empty(SlightPHP\Tpl::$_tpl_vars["good_subject"]->data)){; ?>
						...
						<?php if(!empty(SlightPHP\Tpl::$_tpl_vars["v"]->name)){; ?><div class="col-sm-6 delect-subj pd0 col-xs-4 col-lg-5 col-md-5" contenteditable="false">
					...
					<div class="t-subjects-but col-lg-10 col-md-5 col-sm-10 col-xs-5" style="padding:0;line-height:35px">
						<input id="click-but" type="button" value="添加标签" class="col-lg-4 col-md-15 col-sm-5" style="padding:0;margin-top:0;">
						<span class="cGray visible-lg col-lg-14">至少选择一项，最多选择三项</span>
						<span class="visible-sm cGray col-sm-13">至选少一项,最多三项</span>
					</div>
					</div>
				</li>
				<li>
				...
				<li>
                    <div class="label col-lg-4 col-md-4 col-sm-3 col-xs-7 text-right"style="text-align: right;"><img src="<?php echo utility_cdn::img('/assets_v2/img/platform/x.png'); ?>">我的头衔：</div>
					<div class="label-for col-lg-16 col-md-16 col-sm-17 col-xs-13 row">
				...
				<li>
					...
					<div class="col-lg-20 cGray c-fl"style="line-height: 18px;">用一段话来介绍自己,让学生和家长更好的了解你.最多&nbsp;&nbsp;1000&nbsp;&nbsp;字.
					<span class="tip1 cRed"></span>
					</div>
					<p class="desc-intr"></p>
					</div>
...
$(function(){
	...
	oT_Div_List.on("click",function(){
		...
		if($(this).hasClass("on")){
	    	...
	    	if($('#t-subj-content>div').length>=3){
	            ...
	            $("#t-subj-content").append('<div class="col-sm-1 delect-subj pd0 col-lg-5 col-xs-4"  contenteditable="false">'+$(this).text()+'<input type="hidden" name="good_subject[]" value="'+val+'"/></div>');
	        }
		}
	})
	...
	$('#submit').on('click',function(){
		...
		var params = {
			'name' : $('input[name=name]').val().replace(/((['"])(?:(?!\1).)*?\1)|(^\s*)|(\s*$)/g, ""),
	...
	$("#level1").change(function(){
		...
		if(pid){
			...
			$("#school_type").change(function(event){
