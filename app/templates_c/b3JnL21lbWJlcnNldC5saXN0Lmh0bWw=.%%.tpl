		...
		<div class="row">
			...
			<div class="right-main col-md-16 col-sm-12">
				<div class="com-md-20 pd0 clearfix mb20">
					<?php if(SlightPHP\Tpl::$_tpl_vars["memberCount"] >= 30){; ?>
					<a href="#" class="c-fr add-button fs14" id="add_memberset">
                    	<i class="add-icon c-fl"></i>新建会员类型
                	</a>
					<?php }else{; ?>
					<a href="/org.member.addmemberset" class="c-fr add-button fs14">
                    	<i class="add-icon c-fl"></i>新建会员类型
                	</a>
					<?php }; ?>
				</div>
				<table class="table-grid fs14">
					<thead>
                		<tr>
                    		<td class="col-sm-3">会员类型</td>
                    		<td class="col-sm-3">开通人数</td>
                    		<td class="col-sm-3">有效人数</td>
                    		<td class="col-sm-5">状态</td>
							<td class="col-sm-6">操作</td>
                		</tr>
                	</thead>
					<tbody>
						...
						<tr>
							<td class="col-sm-3"><?php echo SlightPHP\Tpl::$_tpl_vars["mo"]->title; ?></td>
							<td class="col-sm-3"><?php echo SlightPHP\Tpl::$_tpl_vars["mo"]->open_user; ?>人</td>
							<td class="col-sm-3"><?php echo SlightPHP\Tpl::$_tpl_vars["mo"]->valid_user; ?>人</td>
							<td class="col-sm-5">
							...
							<td class="col-sm-6">
								...
								<e>|</e>
								<a href="javascript:;" class="vip-list-btn cursor_poin" data-id="<?php echo SlightPHP\Tpl::$_tpl_vars["mo"]->pk_member_set; ?>">会员列表</a>
								<e>|</e>
								<a href="javascript:;" data-id="<?php echo SlightPHP\Tpl::$_tpl_vars["mo"]->pk_member_set; ?>" data-status="<?php echo SlightPHP\Tpl::$_tpl_vars["mo"]->status; ?>" class="vip-add-btn">添加会员</a>
								<e>|</e>
...
<section id="wrap-member-add" style="display:none;">
	<div class="col-xs-20 fs14 mt10">
		...
		<input class="col-xs-14 pd0 bor1px" name="mobile" type="text"/>
	</div>
	...
	<div class="tac">
		<button class="btn member-add-requestBtn mr10">添加</button>
		<button class="gray-btn member-add-cancleBtn">取消</button>
	</div>
</section>
<!-- /添加会员 -->
...
$(function() {
	...
	$('#wrap-member-add .member-add-requestBtn').click(function() {
		...
		console.log(mobile,setId,price_type,status);
		if(mobile == ''){
			layer.msg('请填写手机号！');
			return;
		}
