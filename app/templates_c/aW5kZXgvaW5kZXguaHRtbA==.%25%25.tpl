...
<div class="container">
    ...
    <div class="tel col-sm-5 hidden-xs">
        <div class="col-sm-16 c-fr"><img src="<?php echo utility_cdn::img('/assets_v2/img/platform/tel.png'); ?>" alt="客服电话"></div>
...
<section id="nav">
    <div class="container">
        ...
        <div class="col-sm-20 col-xs-20 fs16 col-md-15 col-lg-13 nav">
            <ul>
                <li class="col-sm-3 col-xs-4 curr"><a href="/index">首页</a></li>
                <li class="col-sm-3 col-xs-5 visible-xs visible-sm"><a href="/index.course.list">全部课程</a></li>
                <li class="col-sm-3 col-xs-5"><a href="/index.teacher.list">明星教师</a></li>
                <li class="col-sm-3 col-xs-5"><a href="/index.plan.list">直播列表<em class="new-icon"></em></a></li>
                <li class="col-sm-3 hidden-xs hidden-sm"><a href="/index.main.join">我要开课</a></li>
                <li class="col-sm-3 hidden-xs hidden-sm"><a href="/index.main.client">客户端</a></li>
                <li class="col-sm-3 hidden-xs"><a href="/index.help">在线帮助</a></li>
            </ul>
        </div>
    </div>
</section>
...
<!-- 小学 -->
<section id="xiaoxue" class="p40 c-fl">
    <div class="container">
                        ...
                        <ul style="display:block;">
                            ...
                            <li>
                                <a href="<?php echo SlightPHP\Tpl::$_tpl_vars["lv"]->course_url; ?>" target="_blank">
                                    <i><?php echo SlightPHP\Tpl::$_tpl_vars["lk"]+1; ?></i><span><?php echo SlightPHP\Tpl::$_tpl_vars["lv"]->title; ?></span></a></li>
                            <?php }; ?>
                            <?php }; ?>
                        </ul>
                        <ul>
...
<!-- 初中 -->
<section id="chuzhong" class="gray-bg p40 c-fl">
    <div class="container">
        <div class="floor-title">
            <div class="row">
...
<!-- 高中 -->
<section id="gaozhong" class="p40 c-fl">
    <div class="container">
        <div class="floor-title">
            <div class="row">
...
<article>
	...
	<div class="class-reminder" style="display:none;">
		<div class="reminder-ct reminder-ct-one fs14" id="reminder-ct">
			<span class="btn-clear clear-reminder-btn"></span>
			<h6>上课提醒:</h6>
			<p>小学数学奥数复习</p>
			<p>
				<span>第一章</span> <span style="color:#f01400;">8:00</span> <span>正在上课</span>
			</p>
			<h5 class="tec mt10" id="inClassName">
				<a href="<<url>>" title="" class="reminder-comin">进入课堂</a>
			</h5>
		</div>
		<div class="reminder-ct reminder-ct-one fs14" id="reminder-ct">
			<span class="btn-clear clear-reminder-btn"></span>
