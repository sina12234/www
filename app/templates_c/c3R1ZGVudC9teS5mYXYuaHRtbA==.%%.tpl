...
<!-- mob nav -->
			<div class="mob-nav hidden-lg hidden-md">
				<p class="swiper-wrapper" id="mob-nav">
					<a href="/student.main.growth" class="swiper-slidee">我的首页</a>
					...
					<div class="c-fr col-md-15 col-sm-15 col-xs-20 s-pd0 pdl0">
						<div class="s-collect-content-tp">
							<div class="col-sm-6 col-md-6 col-xs-8 s-pd0 pdl0">
								...
								<p><?php echo tpl_modifier_tr(SlightPHP\Tpl::$_tpl_vars["v"]['cate_name'],'course.list'); ?> <?php echo SlightPHP\Tpl::$_tpl_vars["v"]['subject_name']; ?> <?php /*| <?php echo tpl_modifier_tr('共','LearningCenter'); ?><?php echo SlightPHP\Tpl::$_tpl_vars["v"]['section_count']; ?><?php echo tpl_modifier_tr('章','LearningCenter'); ?>*/?></p>
							</div>
				...
				<div class="c-fr col-md-9 col-xs-9 s-pd0">
					<div class="s-collect-content-tp">
						<div class="intro col-sm-3 col-lg-3 col-xs-3 col-md-4 s-pd0">
							...
							<p><<grade_name>> <<cate_name>> <?php /*| 共<<section_count>>章*/?></p>
						</div>
