    ...
    <div class="container">
    	<div class="row">
            ...
            <div class="right-main col-md-16 col-xs-20">
				<!--con start-->
				<div class="s-new-info-base">
					<ul class="fs14 form-horizontal ">
						<li class="item_nickname form-group ">
							<div class="control-label col-xs-6 col-sm-5">
								<em class='cRed'>*</em><?php echo tpl_modifier_tr('昵称','site.user'); ?>：
							</div>
							<div class="label-for col-xs-14 col-sm-10" >
						...
						<li class="form-group ">
							<div class="control-label col-xs-6 col-sm-5">
								<em class="cRed">*</em><?php echo tpl_modifier_tr('真实姓名','site.user'); ?>：
							</div>
							<div class="label-for col-xs-14 col-sm-10">
						...
						<li class="form-group ">
							<div class="control-label col-xs-6 col-sm-5"><em class="cRed">*</em><?php echo tpl_modifier_tr('性别','site.user'); ?>：</div>
							<div class="label-for col-xs-14 col-sm-10">
              ...
              <li class="form-group ">
                <div class="control-label col-xs-6 col-sm-5"><?php echo tpl_modifier_tr('出生日期','site.user'); ?>：</div>
                <div class="label-for col-xs-14 col-sm-10" id="birthday" >
                ...
                <li class="form-group region_info">
                    <div class="control-label col-xs-6 col-sm-5"><em class="cRed">*</em><?php echo tpl_modifier_tr('常住地区','site.user'); ?>：</div>
                    <div class="label-for col-xs-14 col-sm-10">
                ...
                <li class="form-group school_info">
                    <div class="control-label col-xs-6 col-sm-5"><em class="cRed">*</em><?php echo tpl_modifier_tr('教育阶段','site.user'); ?>：</div>
                    <div class="label-for col-xs-14 col-sm-10">
                      <div class="divselect divselect-32 mr10" id="school_type">
                          <cite>
                              <span class="cite-icon"></span>
                      ...
                      <div class="divselect divselect-32 ml10 mr10" id="school">
                          <cite>
                              <span class="cite-icon"></span>
                      ...
                      <div class="divselect divselect-32" id="school_grade">
                          <cite>
                              <span class="cite-icon"></span>
                ...
                <li class="form-group " >
                    <div class="control-label col-xs-6 col-sm-5"><?php echo tpl_modifier_tr('一句话简介','site.teacher'); ?>：</div>
                ...
                <?php if(SlightPHP\Tpl::$_tpl_vars["isTeacher"]===true){; ?>
						<li class="col-xs-20 fs16 fb"><?php echo tpl_modifier_tr('教师资料','site.teacher'); ?></li>
						<li class="form-group ">
							<div class="control-label col-xs-6 col-sm-5">
                        ...
                        <li class="form-group ">
                            <div class="control-label col-xs-6 col-sm-5"><?php echo tpl_modifier_tr('学历','site.teacher'); ?>：</div>
                            <div class="label-for col-xs-14 col-sm-10">
                        ...
                        <li  class="item_2 form-group">
                            <div class="control-label col-xs-6 col-sm-5"><em class='cRed'>*</em><?php echo tpl_modifier_tr('擅长学科','site.teacher'); ?>：</div>
							             <div class="label-for  col-xs-14 col-sm-15">
                                <div class="dropdown col-xs-6 col-sm-10 pd0">
                        ...
                        <li class="item_8 form-group">
                            ...
                            <div class="label-for col-xs-14 col-sm-10 pr0">
                                <input type="text" class="verify-judge col-sm-7 col-xs-20 required" data-valid="isNonEmpty||onlyZh||maxLength:10"  data-error="不能为空||只能输入汉字||最多10个汉字" data-tip="最多输入10个汉字"   id="title" name="title" value="<?php if(!empty(SlightPHP\Tpl::$_tpl_vars["teacher"]->title)){; ?><?php echo SlightPHP\Tpl::$_tpl_vars["teacher"]->title; ?><?php }; ?>">
							               </div>
                        </li>
                        <li class="form-group desc">
                            ...
                            <div class="label-for col-sm-15 col-xs-14">
                                <textarea name="desc" style="height:120px;border:1px solid #dbdbdb;" id="desc" cols="30" rows="3" class="verify-judge col-sm-12 col-xs-20" placeholder=""><?php if(!empty(SlightPHP\Tpl::$_tpl_vars["teacher"]->desc)){; ?><?php echo SlightPHP\Tpl::$_tpl_vars["teacher"]->desc; ?><?php }; ?></textarea>
