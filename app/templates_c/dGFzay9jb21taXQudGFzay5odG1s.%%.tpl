...
<section class="org-section">
    <div class="container main-center">
        <div class="task-title ed-title mb20">
            <div class="tab-button">提交作业</div>
        ...
        <script type="template" id="work-detail">
            <table class="table-grid">
                <thead>
                <tr>
                    <td class="col-md-5 col-xs-10 tal"><%= taskData.create_time%>&nbsp;&nbsp;作业</td>
                    <td class="col-md-7 col-xs-10 pd0">讲师：<%= taskData.teacherName%></td>
                    <td class="col-md-8 col-xs-13">截止时间：<%= taskData.end_time%></td>
                </tr>
                </thead>
            </table>
        ...
        <div class="task-content mt30">
            <div class="task-tag col-lg-2 col-md-3 col-sm-3 col-xs-20 pd0">
                提交作业：
            </div>
            <div class="task-action col-lg-15 col-md-15 col-sm-15 col-xs-20 pd0">
...
<script type="text/javascript">
    $(function() {
        ...
        $('#submit').on('click','.btn',function () {
            ...
            $.ajax('/task/commitTask/commitTask/',{
                dataType:'json',
                type:'post',
                data:taskData,
                success:function (data) {
