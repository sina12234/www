    ...
    <div id="main" class="pos-rel">
        <div id="slide" class="slide_wrap">
            <ul class="slide_imglist conbox">
                ...
                <div class="container">
                  <a href="<?php echo SlightPHP\Tpl::$_tpl_vars["slide"]->slide_link; ?>" target="_blank" class="row">
                      <img src="<?php echo utility_cdn::file(SlightPHP\Tpl::$_tpl_vars["slide"]->slide_url); ?>">
                  </a>
                </div>
                </li>
                <?php }; ?>
        ...
        <div class="login-index hidden-xs hidden-sm">
			<div id="indexuser">
			</div>
			<script>
...
$(function(){
  ...
  var banner_width,banner_height;
  $('#slide li').each(function(){
    banner_width = $(this).find('img').width();
    banner_height = $(this).find('img').height();
    if(banner_width > 890){
      if(window_width > 1920){
        $(this).find('a').css({ 'width':1920});
    }else if(window_width > 1185){
          $(this).find('a').css({ 'width':1920,'margin-left':-(banner_width-1185)/2});
      }else{
        $(this).find('a').css({ 'width':banner_width*5/12,'margin-left':-(banner_width*5/12-window_width)/2});
      }
    }
  })
})
...
<!--即将直播-->
<section id="living" class="live-box pb30">
</section>
        ...
        <ul class="row course-list">
		   ...
		   <?php if(isset(SlightPHP\Tpl::$_tpl_vars["tcv"]->diplayStatus)&&SlightPHP\Tpl::$_tpl_vars["tcv"]->diplayStatus ==1){; ?>
            <li class="col-sm-5 col-lg-5 col-md-5 col-xs-10">
                <div class="course-item">
                    <a href="<?php if(!empty(SlightPHP\Tpl::$_tpl_vars["tcv"]->url)){; ?><?php echo SlightPHP\Tpl::$_tpl_vars["tcv"]->url; ?><?php }else{; ?>/course.info.show/<?php echo SlightPHP\Tpl::$_tpl_vars["tcv"]->course_id; ?><?php }; ?>" target="_blank" class="course-img">
						<?php if(SlightPHP\Tpl::$_tpl_vars["tcv"]->try==1){; ?>
							<i class="try-icon"></i>
						<?php }; ?>
                    ...
                    <a href="/course.info.show/<?php echo SlightPHP\Tpl::$_tpl_vars["tcv"]->course_id; ?>" target="_blank" class="course-tit fs14"><p><?php echo SlightPHP\Tpl::$_tpl_vars["tcv"]->title; ?></p></a>
					<!-- 课程分类-章数-->
                    ...
                    <div class="course-count">
                        ...
                        <div class="course-price">
							<?php if(SlightPHP\Tpl::$_tpl_vars["tcv"]->fee_type==0){; ?>
			...
			<?php if(!empty(SlightPHP\Tpl::$_tpl_vars["tv"]->recommend)&&SlightPHP\Tpl::$_tpl_vars["tv"]->recommend==2){; ?>
				...
				<p class="tac"><a class="index-more" target="_blank" href="<?php if(!empty(SlightPHP\Tpl::$_tpl_vars["tv"]->set_url)){; ?><?php echo SlightPHP\Tpl::$_tpl_vars["tv"]->set_url; ?><?php }; ?>" style="margin-top:20px">更多<?php echo SlightPHP\Tpl::$_tpl_vars["tv"]->title; ?>&gt;&gt;</a></p>
				<?php }; ?>
			<?php }else{; ?>
				<?php if(!empty(SlightPHP\Tpl::$_tpl_vars["tv"]->courses)&&count(SlightPHP\Tpl::$_tpl_vars["tv"]->courses)>4){; ?>
				<p class="tac"><a class="index-more" target="_blank" href="/course.list<?php if(!empty(SlightPHP\Tpl::$_tpl_vars["tv"]->query)){; ?>?<?php echo SlightPHP\Tpl::$_tpl_vars["tv"]->query; ?><?php }; ?>" style="margin-top:20px">更多<?php echo SlightPHP\Tpl::$_tpl_vars["tv"]->title; ?>&gt;&gt;</a></p>
				<?php }; ?>
			<?php }; ?>
...
<section class="index-section">
        ...
        <div class="row">
            ...
            <div class="c-fl mt10 u-lector-box col-md-20 pd0 mb10 swiper-container-horizontal swiper-container4" style="float:left;width:100%">
                ...
                <li class="col-sm-10 col-md-4 col-xs-10 lector-list swiper-slide">
                        <a href="/teacher/detail/entry/<?php echo SlightPHP\Tpl::$_tpl_vars["teacher"]['user_id']; ?>" target="_blank" class="u-lector">
                            <div class="pic">
                                <?php if(!empty(SlightPHP\Tpl::$_tpl_vars["teacher"]['thumb_big'])){; ?>
                                <img class="imgPic" src="<?php echo utility_cdn::file(SlightPHP\Tpl::$_tpl_vars["teacher"]['thumb_big']); ?>"> <?php }else{; ?>
                                <img class="imgPic" src="<?php echo utility_cdn::img('/assets_v2/img/defaultPhoto.gif'); ?>"> <?php }; ?>
                            </div>
    ...
    <p class="tac"><a class="index-more" target="_blank" href="/teacher.list" style="margin-top:20px"><?php echo tpl_modifier_tr('更多老师','site.index'); ?>>></a> <?php }; ?>
    </div>
</section>
<?php }; ?>
<!--资讯-->
...
<section class="index-section hidden-sm">
    <div class="container">
        ...
        <div class="row mt10">
            <ul class="newslist-img pdl0 <?php if(count(SlightPHP\Tpl::$_tpl_vars["noticeList"]->data)>4){; ?>col-md-10<?php }else{; ?>col-md-20<?php }; ?>">
                ...
                <li class="<?php if(count(SlightPHP\Tpl::$_tpl_vars["noticeList"]->data)=='1'){; ?>col-md-20 col-xs-20<?php }elseif((count(SlightPHP\Tpl::$_tpl_vars["noticeList"]->data)>1 and  count(SlightPHP\Tpl::$_tpl_vars["noticeList"]->data) <=4)){; ?>col-md-10<?php }; ?>">
                    <a href="<?php if(!empty(SlightPHP\Tpl::$_tpl_vars["noticeList"]->data[0]->notice_link)){; ?><?php echo SlightPHP\Tpl::$_tpl_vars["noticeList"]->data[0]->notice_link; ?><?php }else{; ?>/activity.main.info/<?php echo SlightPHP\Tpl::$_tpl_vars["noticeList"]->data[0]->pk_notice_id; ?><?php }; ?>">
                        ...
                        <p class="news-img col-md-6 col-xs-7"><img src="<?php echo SlightPHP\Tpl::$_tpl_vars["noticeList"]->data[0]->thumb; ?>"></p>
                        <?php }; ?>
                    </a>
                </li>
                <?php }; ?>
                ...
                <li class="<?php if(count(SlightPHP\Tpl::$_tpl_vars["noticeList"]->data)=='1'){; ?>col-md-20<?php }elseif((count(SlightPHP\Tpl::$_tpl_vars["noticeList"]->data)>1 and  count(SlightPHP\Tpl::$_tpl_vars["noticeList"]->data) <=4)){; ?>col-md-10<?php }; ?>">
                    <a href="<?php if(!empty(SlightPHP\Tpl::$_tpl_vars["noticeList"]->data[1]->notice_link)){; ?><?php echo SlightPHP\Tpl::$_tpl_vars["noticeList"]->data[1]->notice_link; ?><?php }else{; ?>/activity.main.info/<?php echo SlightPHP\Tpl::$_tpl_vars["noticeList"]->data[1]->pk_notice_id; ?><?php }; ?>">
                        ...
                        <p class="news-img col-md-6 col-xs-7"><img src="<?php echo SlightPHP\Tpl::$_tpl_vars["noticeList"]->data[1]->thumb; ?>"></p>
                        <?php }; ?>
                    </a>
                </li>
                <?php }; ?>
                ...
                <li class="<?php if(count(SlightPHP\Tpl::$_tpl_vars["noticeList"]->data)=='1'){; ?>col-md-20<?php }elseif((count(SlightPHP\Tpl::$_tpl_vars["noticeList"]->data)>1 and  count(SlightPHP\Tpl::$_tpl_vars["noticeList"]->data) <=4)){; ?>col-md-10<?php }; ?>">
                    <a href="<?php if(!empty(SlightPHP\Tpl::$_tpl_vars["noticeList"]->data[2]->notice_link)){; ?><?php echo SlightPHP\Tpl::$_tpl_vars["noticeList"]->data[2]->notice_link; ?><?php }else{; ?>/activity.main.info/<?php echo SlightPHP\Tpl::$_tpl_vars["noticeList"]->data[2]->pk_notice_id; ?><?php }; ?>">
                        ...
                        <p class="news-img col-md-6 col-xs-7"><img src="<?php echo SlightPHP\Tpl::$_tpl_vars["noticeList"]->data[2]->thumb; ?>"></p>
                        <?php }; ?>
                    </a>
                </li>
                <?php }; ?>
                ...
                <li class="col-md-10">
                    <a href="<?php if(!empty(SlightPHP\Tpl::$_tpl_vars["noticeList"]->data[3]->notice_link)){; ?><?php echo SlightPHP\Tpl::$_tpl_vars["noticeList"]->data[3]->notice_link; ?><?php }else{; ?>/activity.main.info/<?php echo SlightPHP\Tpl::$_tpl_vars["noticeList"]->data[3]->pk_notice_id; ?><?php }; ?>">
                        ...
                        <p class="news-img col-md-6 col-xs-7"><img src="<?php echo SlightPHP\Tpl::$_tpl_vars["noticeList"]->data[3]->thumb; ?>"></p>
                        <?php }; ?>
                    </a>
                </li>
                <?php }; ?>
            ...
            <div class="newslist-txt col-md-10 fs14 hidden-xs">
                ...
                <a href="<?php if(!empty(SlightPHP\Tpl::$_tpl_vars["nlv"]->notice_link)){; ?><?php echo SlightPHP\Tpl::$_tpl_vars["nlv"]->notice_link; ?><?php }else{; ?>/activity.main.info/<?php echo SlightPHP\Tpl::$_tpl_vars["nlv"]->pk_notice_id; ?><?php }; ?>">
        ...
        <p class="tac mt20"><a class="index-more" target="_blank" href="/activity.main.list"><?php echo tpl_modifier_tr('更多资讯','site.index'); ?>>></a></p>
        <?php }; ?>
    </div>
</section>
<?php }; ?>
