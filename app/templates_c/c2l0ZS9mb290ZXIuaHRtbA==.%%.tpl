<?php if(!empty(SlightPHP\Tpl::$_tpl_vars["is_pro"])){; ?>
	...
	<div class="container">
		<div class="row">
			<div class="foot-tag col-lg-10 col-md-12 hidden-xs hidden-sm">
				...
				<?php if(isset(SlightPHP\Tpl::$_tpl_vars["orgInfo"]->oid)&&SlightPHP\Tpl::$_tpl_vars["orgInfo"]->is_pro=='1'&&SlightPHP\Tpl::$_tpl_vars["orgInfo"]->oid=='842'){; ?>
			...
			<div class="foot-info col-lg-10 col-md-8 col-sm-20 col-xs-20 right ">
				<div class="project-info right">
					<div class="project-title hidden-xs hidden-sm">
						<?php if(isset(SlightPHP\Tpl::$_tpl_vars["orgInfo"]->subname)){; ?><?php echo SlightPHP\Tpl::$_tpl_vars["orgInfo"]->subname; ?><?php }; ?>
					</div>
					...
					<div class="company-name">
						<?php if(isset(SlightPHP\Tpl::$_tpl_vars["orgInfo"]->subname)){; ?><?php echo SlightPHP\Tpl::$_tpl_vars["orgInfo"]->name; ?><?php }; ?>
					</div>
					<div class="company-regId">
						京ICP备14053191号
					</div>
				</div>
				<?php if(!empty(SlightPHP\Tpl::$_tpl_vars["is_pro"]) && SlightPHP\Tpl::$_tpl_vars["is_pro"]==1 && !empty(SlightPHP\Tpl::$_tpl_vars["twoWeiMa"])){; ?>
				<div class="QR-code right hidden-xs hidden-sm">
					<div class="img-box">
						<img src="<?php echo utility_cdn::file(SlightPHP\Tpl::$_tpl_vars["twoWeiMa"]); ?>" alt="">
					</div>
...
<p class="cGray">Copyright© 2017 <?php echo tpl_modifier_tr('北京高能壹佰教育科技有限公司',"site.footer"); ?></p>
...
<?php }; ?>
<div style="display:none"><?php echo tpl_function_part('/site.main.statistic'); ?></div>
