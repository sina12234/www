...
<div class="th_banner" style="background: url('<?php echo utility_cdn::img(SlightPHP\Tpl::$_tpl_vars["info"]->imgBanner); ?>') top center no-repeat">
    <!--banner换肤区域-->
    <div  class="container_teac container">
        ...
        <div class="row col-md-20  th_pic">
            <div class="th_p col-md-8 col-md-offset-6 tec">
                <span class="pho_pic"><img src="<?php if(!empty(SlightPHP\Tpl::$_tpl_vars["info"]->thumb_big)){; ?><?php echo utility_cdn::file(SlightPHP\Tpl::$_tpl_vars["info"]->thumb_big); ?><?php }; ?>" /></span>
                <h2 class="mt25">
    ...
    <div class="skin_box" style="display: none">
        <div class="container skin_cent">
            <ul class="skin_bg">
                <li><em></em><img data="/assets_v2/img/skin1.jpg" src="<?php echo utility_cdn::img('/assets_v2/img/skin1.jpg'); ?>"></li>
                <li><em></em><img data="/assets_v2/img/skin2.jpg" src="<?php echo utility_cdn::img('/assets_v2/img/skin2.jpg'); ?>"></li>
                <li><em></em><img data="/assets_v2/img/skin3.jpg" src="<?php echo utility_cdn::img('/assets_v2/img/skin3.jpg'); ?>"></li>
                <li><em></em><img data="/assets_v2/img/skin4.jpg" src="<?php echo utility_cdn::img('/assets_v2/img/skin4.jpg'); ?>"></li>
                <li><em></em><img data="/assets_v2/img/skin5.jpg" src="<?php echo utility_cdn::img('/assets_v2/img/skin5.jpg'); ?>"></li>
            </ul>
            <div class="clear">
...
<nav class="th_nav tec col-xs-20">
    <div class="container swiper-container swiper-continer">
      <div class="swiper-ul-width swiper-wrapper">
        <li class="swiper-slide col-xs-4">
            <a <?php if(SlightPHP\Tpl::$_tpl_vars["nav"]=="entry"){; ?>class="nav_hover"<?php }; ?> href="/teacher/detail/entry/<?php echo SlightPHP\Tpl::$_tpl_vars["tid"]; ?>">
        ...
        <li class="swiper-slide col-xs-4"><a <?php if(SlightPHP\Tpl::$_tpl_vars["nav"]=="course"){; ?>class="nav_hover"<?php }; ?> href="/teacher/detail/course/<?php echo SlightPHP\Tpl::$_tpl_vars["tid"]; ?>">主讲课程</a></li>
        <li class="swiper-slide col-xs-4"><a <?php if(SlightPHP\Tpl::$_tpl_vars["nav"]=="style"){; ?>class="nav_hover"<?php }; ?> href="/teacher/detail/style/<?php echo SlightPHP\Tpl::$_tpl_vars["tid"]; ?>">教师相册</a></li>
        <li class="swiper-slide col-xs-4"><a <?php if(SlightPHP\Tpl::$_tpl_vars["nav"]=="article"){; ?>class="nav_hover"<?php }; ?> href="/teacher/detail/article/<?php echo SlightPHP\Tpl::$_tpl_vars["tid"]; ?>">文章资料</a></li>
        <li class="swiper-slide col-xs-4"><a <?php if(SlightPHP\Tpl::$_tpl_vars["nav"]=="comment"){; ?>class="nav_hover"<?php }; ?> href="/teacher/detail/comment/<?php echo SlightPHP\Tpl::$_tpl_vars["tid"]; ?>">学生评价</a></li>
      </div>
    </div>
</nav>
