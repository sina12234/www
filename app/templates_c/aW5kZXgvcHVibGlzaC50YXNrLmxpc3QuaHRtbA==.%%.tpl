            ...
            <div class="right-main col-sm-20  col-md-16 col-xs-20">
                <div class="mob-nav hidden-lg hidden-md">
                    <ul class="swiper-wrapper" id="mob-nav">
                        <li class="swiper-slide"><a href="/index.growth.entry">我的首页</a></li>
                        <li class="swiper-slide"><a href="/index.student.course">我的课程</a></li>
                        <li class="swiper-slide"><a href="/index.task.studentTaskListShow" class="active">我的作业</a></li>
                                ...
                                <ul class="zoom-list zoom-down">
                                    ...
                                    <li class="col-md-20 p0">
                                        ...
                                        <div class="co-md-20 zoom-info zoom-down clearfix p10" data-taskId="<%= p%>" >
                                            ...
                                            <!-- /lt -->
                                            <!-- rt -->
                                            <div class="col-md-17 zoom-info-course p15 clearfix col-xs-14 row">
                                                <div class="row">
                                                <div class="col-md-6">
                                                ...
                                                <div class="col-md-9">
                                                    ...
                                                    <p class="task_text_info">
                                                        ...
                                                        <a href="/index.task.studentCommitTask?taskId=<%= p.match(/\d+/)[0]%>"  title="" ><%= initTaskTitle(workData[p].desc,workData[p].attach,workData[p].thumb)%></a>
                                                        <% } else if(workData[p].student_status == "1") { %>
                                                        <a href="/index.task.taskCorrectShow?taskId=<%= p.match(/\d+/)[0]%>&type=noCorrect&studentId=<%= workData[p].pk_task_student%>" title="" target="_blank" ><%= initTaskTitle(workData[p].desc,workData[p].attach,workData[p].thumb)%></a>
                                                        <%} else if(workData[p].student_status == "2"){ %>
                                                        <a href="/index.task.taskCorrectShow?taskId=<%= p.match(/\d+/)[0]%>&type=correct&studentId=<%= workData[p].pk_task_student%>" target="_blank" title="" ><%= initTaskTitle(workData[p].desc,workData[p].attach,workData[p].thumb)%></a>
                                                        <%} else if(workData[p].student_status == "4"){ %>
                                                        <a href="/index.task.studentCommitTask?taskId=<%= p.match(/\d+/)[0]%>&type=correct&studentId=<%= workData[p].pk_task_student%>" target="_blank" title="" ><%= initTaskTitle(workData[p].desc,workData[p].attach,workData[p].thumb)%></a>
                                                        <%}%>
                                                    </p>
                                                    <% } else { %>
                                                    <p>暂无标题</p>
                                                ...
                                                <div class="col-md-5 zoom-info-action">
                                                    <%  if(workData[p].student_status == 4 ){ %>
                                                    <a href="/index.task.studentCommitTask?taskId=<%= p.match(/\d+/)[0]%>"  title="" class="blue-link" >提交</a>
                                                    <% } else if(workData[p].student_status == "1") { %>
                                                    <a href="/index.task.taskCorrectShow?taskId=<%= p.match(/\d+/)[0]%>&type=noCorrect&studentId=<%= workData[p].pk_task_student%>" title="" target="_blank" class="blue-link">查看</a>
                                                    <%} else if(workData[p].student_status == "2"){ %>
                                                    <a href="/index.task.taskCorrectShow?taskId=<%= p.match(/\d+/)[0]%>&type=correct&studentId=<%= workData[p].pk_task_student%>" target="_blank" title="" class="blue-link">查看结果</a>
                                                    <% }%>
                                                </div>
                                                </div>
                                            </div>
...
function initTaskTitle(desc,attach,thumb) {
    ...
    $(function () {
        ...
        function getWorkList(status,page) {
            ...
            $.ajax('/index/task/studentTaskList',{
                dataType:'json',
                type:'get',
                data:{
                    status:workStatus,
                ...
                success:function (data) {
                    ...
                    if(result.code == 200){
                        ...
                        $('#content').find('.block-list').append(ejs.render(listHtml, { data: newData,page:page}))
                    }else{
                        $('#no-data').addClass('show');
                    }
                },
...
<script type="text/javascript" src="/assets_v2/js/swiper.min.js?ver=109"></script>
<script>
//导航移动端
$(function(){
if ($(window).width() < 768) {
    ...
    var li_width = 0;
    var mob_width=$("#mob-nav li").outerWidth();
