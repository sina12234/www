...
<<#data>>
	<dl class="col-md-20 pd0">
		<dd><p class="col-md-10"><<title>></p><p class="col-md-5">推广商：<<resellOrgName>></p></dd>
		<dd>
                    <p class="col-md-10">班级：<<className>></p>
                    <p class="col-md-5">成本价：￥<<pricePromote>><br>订单价格：￥<<price>></p>
                    <p class="col-md-5 tac"><span class="fsRed">￥<<income>></span></p>
                </dd>
		<dd>
...
$(function() {
    $('.view-settled-btn li').click(function() {
        ...
        if(param.linum == 0){
            ...
            param.head  = "<div class='col-md-8 bgf5 tac mt10 view-extension'>课程信息</div><div class='col-md-6 bgf5 tac mt10 view-extension'>推广信息</div><div class='col-md-6 bgf5 tac mt10 view-extension'>总收入</div></div><div id='ditchCon'></div>";
