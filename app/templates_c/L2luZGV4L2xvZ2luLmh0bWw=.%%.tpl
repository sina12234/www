    ...
    <div class="row">
        <section id="wrap-login">
            ...
            <div class="login-content pd0 col-sm-10 c-fr mr15 clearfix col-md-7">
                <ul class="login-content-btn fs14 col-sm-20 tac pd0 col-xs-20 clearfix">
                    <li class="col-sm-10 col-xs-10 curr">账号密码登录</li>
                    <li class="col-sm-10 col-xs-10 ">手机动态码登录</li>
                </ul>
                <ul class="login-content-ct bor1px clearfix col-xs-20 col-sm-20 pd0">
                    <li class="col-sm-20 col-xs-20 mt20" style="display:block;">
                        <form action="" id="yunkeSubmit" method="post" autocomplete="off">
                            <div class="pos-rel col-sm-20 col-xs-20 pd0 mb20">
                                <div class="c-fl mr10 category-mobile fs12 tac bor1px">
					...
					<form action="" id="smsForm" method="post" autocomplete="off">
                        <div class="pos-rel col-sm-20 col-xs-20 pd0 mb20">
                            ...
                            <dl class="fs12 pos-abs col-sm-20 col-xs-20 pd0 areaCountry bor1px" style="display:none;">
                               <div id="smsInternationCode"></div>
                                <dd class="col-sm-20 col-xs-20 tac clearfix smsMoreAreaCountry">
                                    更多国家
                                </dd>
								<input type="hidden" name="cid" value="1"/>
                            </dl>
						...
						<div class="col-sm-20 col-xs-20 pd0 mb20 pos-rel">
                                ...
                                <img id="cap" src="/captcha.gen" class="col-md-5 col-xs-7" height="40" alt="">
                        </div>
                        <div class="col-sm-20 col-xs-20 pd0 mb20">
                            <div class="pd0 pos-abs" style="right:110px;left:0px;">
                                <input type="text" name="password" class="bor1px col-sm-20 col-xs-20 password-ipt iptFocusBlur" placeholder="请输入手机动态码" />
                            </div>
                            <div class="col-sm-5 col-xs-5 pd0 c-fr">
                                <input type="button" value="获取验证码" class="c-fr VerificatCodeBtn bor1px tac" id="get_verify_code">
                            </div>
                        </div>
                        <div class="col-sm-20 col-xs-20 pd0 mb20">
                            <label class="c-fl">
