				...
				<?php foreach(SlightPHP\Tpl::$_tpl_vars["teacherList"] as SlightPHP\Tpl::$_tpl_vars["to"]){; ?>
                    <li class="fs12">
                        <div class="col-sm-6 col-xs-6 col-lg-4 col-md-6">
							<a target="_blank" href="<?php echo SlightPHP\Tpl::$_tpl_vars["to"]->show_url; ?>" class="user-avatar"><img src="<?php echo utility_cdn::file(SlightPHP\Tpl::$_tpl_vars["to"]->thumb_big); ?>" alt="<?php echo SlightPHP\Tpl::$_tpl_vars["to"]->name; ?>"></a>
                        ...
                        <div class="col-sm-6 fs14 col-lg-5 col-md-6 mobile-phone">
                            ...
                            <?php echo SlightPHP\Tpl::$_tpl_vars["to"]->avg_score/10; ?>分
                            <?php }else{; ?>
                            &nbsp;
                            <?php }; ?>
                            </span>
