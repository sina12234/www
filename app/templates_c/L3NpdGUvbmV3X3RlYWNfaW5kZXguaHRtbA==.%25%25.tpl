...
<article class="container mt40 mb40">
        ...
        <article class="mt20 c-fl">
	        ...
	        <font style="display: none"><?php if(!empty(SlightPHP\Tpl::$_tpl_vars["info"]->avg_score)){; ?><?php echo SlightPHP\Tpl::$_tpl_vars["info"]->avg_score*2; ?><?php }else{; ?>00<?php }; ?>%</font>
                ...
                <div class="eval_pl col-md-20">
                    <span class="col-md-10" style="border-right:1px solid #e9e9e9;">综合得分<em><?php echo SlightPHP\Tpl::$_tpl_vars["info"]->avg_score/10; ?></em></span>
                    <span class="col-md-10">评价数<em><?php echo SlightPHP\Tpl::$_tpl_vars["info"]->comment; ?></em></span>
                </div>
            </div>
        </article>
    </div>
    ...
    <?php }else{; ?>
        <div class="col-md-15 th_m_r mt20 c-fl">
            ...
            <?php }else{; ?>
                <div class="col-md-6 col-md-offset-6 mt20 tec pd45 c-fl">
                    <img src="<?php echo utility_cdn::img('/assets_v2/img/blank_pic.jpg'); ?>" >
                    <p class="mt10 c_a3 fs16"  >老师还在准备中...</p>
                </div>
            <?php }; ?>
                    ...
                    <ul>
                        <?php foreach(SlightPHP\Tpl::$_tpl_vars["imgList"] as SlightPHP\Tpl::$_tpl_vars["v"]){; ?>
                            <li class="col-md-6 col-sm-6 ">
                                <a href='/index/teacherblog/imgInfo/<?php echo SlightPHP\Tpl::$_tpl_vars["tid"]; ?>/<?php echo SlightPHP\Tpl::$_tpl_vars["v"]['imgId']; ?>'><img src="<?php echo SlightPHP\Tpl::$_tpl_vars["v"]['thumb_med']; ?>"></a>
                            </li>
                        <?php }; ?>
                    </ul>
                </div>
                <?php }else{; ?>
                <div class="col-md-6 col-md-offset-6 mt20 tec pd45 c-fl col-xs-20">
                    <img src="<?php echo utility_cdn::img('/assets_v2/img/blank_pic.jpg'); ?>" >
                    <p class="mt10 c_a3 fs16"  >老师还在准备中...</p>
                </div>
                <?php }; ?>
