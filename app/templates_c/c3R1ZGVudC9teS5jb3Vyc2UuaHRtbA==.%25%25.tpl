...
<div class="mob-nav hidden-lg hidden-md">
    <p class="swiper-wrapper" id="mob-nav">
        ...
        <a href="/student.course.mycourse" class="swiper-slide active">我的课程</a>
            ...
            <div class="right-main col-md-16 col-xs-20" id="sc-wrap-my-course">
                <div class="tab-main">
                    <div class="tab-hd fs14" id="tab-hd">
                        ...
                        <a href="javascript:;" class="tab-hd-opt curr"><?php echo tpl_modifier_tr('报名课程','LearningCenter'); ?>（<?php echo SlightPHP\Tpl::$_tpl_vars["course_count"]; ?>）</a>
                    </div>
                </div>
					...
					<?php if(!empty(SlightPHP\Tpl::$_tpl_vars["planlist"])){; ?>
                        ...
                        <div class="my-course-contents col-sm-20 plan-list col-xs-20 pd0">
                            ...
                            <div class="col-sm-17 col-xs-13 my-course-contents-rt p15">
                                ...
                                <div class="fs14 mt20 col-sm-20 col-xs-20">
                        ...
                        <div class="my-course-content col-sm-20 pd0">
							...
							<?php if(!empty(SlightPHP\Tpl::$_tpl_vars["user_course"])){; ?>
                                ...
                                <li class="col-sm-10 bor1px col-xs-20">
                                	<a href="//<?php if(!empty(SlightPHP\Tpl::$_tpl_vars["co"]->subdomain)){; ?><?php echo SlightPHP\Tpl::$_tpl_vars["co"]->subdomain; ?><?php }; ?><?php echo SlightPHP\Tpl::$_tpl_vars["co"]->section_url; ?>" title="<?php echo SlightPHP\Tpl::$_tpl_vars["co"]->title; ?>" class="t-course-info" target="_blank">
	                                    ...
	                                    <div class="col-sm-10 col-xs-20">
	                                        ...
	                                        <p><?php echo tpl_modifier_tr(SlightPHP\Tpl::$_tpl_vars["co"]->class_name,'site.index'); ?> &nbsp;<?php echo tpl_modifier_tr('主讲','LearningCenter'); ?>：
										...
										<div class="fs14 col-sm-20 col-xs-20">
											<a href="//<?php if(!empty(SlightPHP\Tpl::$_tpl_vars["co"]->subdomain)){; ?><?php echo SlightPHP\Tpl::$_tpl_vars["co"]->subdomain; ?><?php }; ?>" target='_blank'>
											<span class="c-fl client-logo-name">
