...
<div class="container">
    <div class="col-sm-4 categorys cWhite hidden-xs col-md-5 col-lg-4 hidden-sm" id="all_cate">
        ...
        <div class="col-sm-20 col-xs-20 fs16 col-md-15 col-lg-13 nav">
            <ul>
                <li class="col-sm-3 col-xs-4"><a href="/index">首页</a></li>
                <li class="col-sm-3 col-xs-5 visible-xs visible-sm <?php if(SlightPHP\Tpl::$_tpl_vars["nav"] == 'course'){; ?>curr<?php }; ?>"><a href="/index.course.list">全部课程</a></li>
                <li class="col-sm-3 col-xs-5 <?php if(SlightPHP\Tpl::$_tpl_vars["nav"] == 'teacher'){; ?>curr<?php }; ?>"><a href="/index.teacher.list">明星教师</a></li>
                <li class="col-sm-3 col-xs-5 <?php if(SlightPHP\Tpl::$_tpl_vars["nav"] == 'plan'){; ?>curr<?php }; ?>"><a href="/index.plan.list">直播列表<em class="new-icon"></em></a></li>
                <li class="col-lg-3 hidden-sm hidden-md hidden-xs <?php if(SlightPHP\Tpl::$_tpl_vars["nav"] == 'join'){; ?>curr<?php }; ?>"><a href="/index.main.join">我要开课</a></li>
                <li class="col-lg-3 hidden-sm hidden-md hidden-xs <?php if(SlightPHP\Tpl::$_tpl_vars["nav"] == 'pc'){; ?>curr<?php }; ?>"><a href="/index.main.client">客户端</a></li>
                <li class="col-sm-3 hidden-xs <?php if(SlightPHP\Tpl::$_tpl_vars["nav"] == 'help'){; ?>curr<?php }; ?>"><a href="/index.help">在线帮助</a></li>
            </ul>
        </div>
    </div>
</section>
