			...
			<?php /*
				...
				*/?>
				...
				<p>
					...
					<span class="c-fr fs14"><?php echo tpl_modifier_tr('共','site.teacher'); ?><?php if(!empty(SlightPHP\Tpl::$_tpl_vars["listPlans"]->data)){; ?><?php echo count(SlightPHP\Tpl::$_tpl_vars["listPlans"]->data); ?><?php }else{; ?>0<?php }; ?><?php echo tpl_modifier_tr('章','site.teacher'); ?></span>
				</p>
			</div>
		</div>
	<!-- /课程信息 -->
					...
					<li class="col-md-5 col-xs-20" style="margin-bottom: 30px;">
						<label>
							...
							<div class="brief-introduction c-fl">
								<p class="fs14"><?php echo SlightPHP\Tpl::$_tpl_vars["v"]->title; ?>
								<?php if(SlightPHP\Tpl::$_tpl_vars["v"]->type == 1){; ?> .txt<?php }elseif( SlightPHP\Tpl::$_tpl_vars["v"]->type==2){; ?> .pdf<?php }elseif( SlightPHP\Tpl::$_tpl_vars["v"]->type==3){; ?>.doc
								<?php }elseif( SlightPHP\Tpl::$_tpl_vars["v"]->type==4){; ?>.docx<?php }elseif( SlightPHP\Tpl::$_tpl_vars["v"]->type==5){; ?>.ppt<?php }elseif( SlightPHP\Tpl::$_tpl_vars["v"]->type==6){; ?>.pptx
								<?php }elseif( SlightPHP\Tpl::$_tpl_vars["v"]->type==7){; ?>.jpg<?php }elseif( SlightPHP\Tpl::$_tpl_vars["v"]->type==8){; ?>.xls<?php }elseif( SlightPHP\Tpl::$_tpl_vars["v"]->type==9){; ?>.xlsx<?php }; ?>
								</p>
   ...
   //AllCheck
	...
	if($(window).width() < 760) {
	  ...
	  $("#upload_data").click(function(){
	    layer.open({
	        type: 2,
	        title:["<?php echo tpl_modifier_tr('上传资料','site.teacher'); ?>"],
	        area: ['480px', '380px'],
	        shadeClose: true,
