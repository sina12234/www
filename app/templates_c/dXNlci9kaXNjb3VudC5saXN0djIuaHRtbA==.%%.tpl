...
<div class="container">
	<div class="row">
			...
			<?php }; ?>
				<div class="content">
					  <p class='pdl5 cDarkgray fs16 fob c-fl coopen-T' style="padding-bottom:20px;"><?php echo tpl_modifier_tr('优惠管理','org'); ?></p>
					  <p id="faq" class="c-fr"><?php echo tpl_modifier_tr('创建新优惠','org'); ?></p>
					<?php if(SlightPHP\Tpl::$_tpl_vars["discounts"]->total>0){; ?>
					<div class='col-sm-12 col-xs-12 col-md-20' style="margin-bottom:20px;padding:0" id="discount">
                        ...
                        <table class="table-grid">
                            <thead class="fs14">
                                <tr>
                                    <td class="col-sm-3 col-md-4 tec"><?php echo tpl_modifier_tr('优惠名称','org'); ?></td>
                                    <td class="hidden-sm hidden-lg hidden-md"><?php echo tpl_modifier_tr('类型','org'); ?></td>
                                    <!--
                                    <td class="hidden-sm visible-lg col-lg-2"><?php echo tpl_modifier_tr('单张券限制','org'); ?></td>
                                    <td class="hidden-sm visible-lg col-lg-2"><?php echo tpl_modifier_tr('单个用户限制','org'); ?></td>
                                    -->
                                    <td class="col-sm-3 col-md-4"><?php echo tpl_modifier_tr('优惠内容','org'); ?></td>
                                    <td class="col-sm-3 col-md-4"><?php echo tpl_modifier_tr('有效时长','org'); ?></td>
                                    <td class="hidden-sm col-md-4"><?php echo tpl_modifier_tr('范围','org'); ?></td>
                                    <td class="col-sm-3 col-md-4"><?php echo tpl_modifier_tr('操作','org'); ?></td>
                                </tr>
                            </thead>
                            <tbody>
						    <?php foreach(SlightPHP\Tpl::$_tpl_vars["discounts"]->data as SlightPHP\Tpl::$_tpl_vars["discount"]){; ?>
                                <tr>
                                    <td class="col-sm-3 col-md-4"><a href="/org.discount.listcodev2/<?php echo SlightPHP\Tpl::$_tpl_vars["discount"]->discount_id; ?>"><?php echo SlightPHP\Tpl::$_tpl_vars["discount"]->name; ?></a></td>
								<?php if(1==SlightPHP\Tpl::$_tpl_vars["discount"]->discount_type){; ?>
                                    <td class="hidden-sm hidden-lg col-md-3">满额减</td>
                                    <td class="col-sm-3 col-md-4"><?php echo tpl_modifier_tr('满','org'); ?><?php echo SlightPHP\Tpl::$_tpl_vars["discount"]->min_fee/100; ?><?php echo tpl_modifier_tr('减','org'); ?><?php echo SlightPHP\Tpl::$_tpl_vars["discount"]->discount_value/100; ?></td>
                                <?php }else{; ?>
                                    <td class="hidden-sm col-md-4"><?php echo tpl_modifier_tr('满','org'); ?><?php echo SlightPHP\Tpl::$_tpl_vars["discount"]->min_fee/100; ?><?php echo tpl_modifier_tr('打','org'); ?><?php echo SlightPHP\Tpl::$_tpl_vars["discount"]->discount_value/10; ?><?php echo tpl_modifier_tr('折','org'); ?></td>
                                <?php }; ?>
								<!--
								<td class="hidden-sm visible-lg col-lg-2"><?php if(0==SlightPHP\Tpl::$_tpl_vars["discount"]->total_num){; ?><?php echo tpl_modifier_tr('不限制','org'); ?><?php }else{; ?><?php echo tpl_modifier_tr('使用','org'); ?><?php echo SlightPHP\Tpl::$_tpl_vars["discount"]->total_num; ?><?php echo tpl_modifier_tr('次','org'); ?><?php }; ?></td>
								<td class="hidden-sm visible-lg col-lg-2"><?php if(0==SlightPHP\Tpl::$_tpl_vars["discount"]->user_limit){; ?><?php echo tpl_modifier_tr('不限制','org'); ?><?php }else{; ?><?php echo tpl_modifier_tr('使用','org'); ?><?php echo SlightPHP\Tpl::$_tpl_vars["discount"]->user_limit; ?><?php echo tpl_modifier_tr('次','org'); ?><?php }; ?></td>
								-->
                                    <td class="col-sm-3 col-md-4"><?php if(0==SlightPHP\Tpl::$_tpl_vars["discount"]->duration){; ?><?php echo tpl_modifier_tr('永久','org'); ?><?php }else{; ?><?php echo SlightPHP\Tpl::$_tpl_vars["discount"]->duration/86400; ?><?php echo tpl_modifier_tr('天','org'); ?><?php }; ?></td>
                                    <td class="col-sm-3 col-md-4"><?php if(0==SlightPHP\Tpl::$_tpl_vars["discount"]->course_id){; ?><?php echo tpl_modifier_tr(SlightPHP\Tpl::$_tpl_vars["discount"]->course_name,'org'); ?><?php }else{; ?><a href="/course.info.show/<?php echo SlightPHP\Tpl::$_tpl_vars["discount"]->course_id; ?>"><?php echo SlightPHP\Tpl::$_tpl_vars["discount"]->course_name; ?></a><?php }; ?></td>
                                    <td class="col-sm-3 col-md-4" data-id="<?php echo SlightPHP\Tpl::$_tpl_vars["discount"]->discount_id; ?>" data-status="<?php echo SlightPHP\Tpl::$_tpl_vars["discount"]->status; ?>"><?php if(0==SlightPHP\Tpl::$_tpl_vars["discount"]->status){; ?><?php echo tpl_modifier_tr('暂停使用','org'); ?><?php }else{; ?><?php echo tpl_modifier_tr('重新启动','org'); ?><?php }; ?></td>
                                </tr>
						    <?php }; ?>
                            </tbody>
                        </table>
					...
					<div class="form fs16">
						<div class="form-group coupon-form col-md-20 mb20">
							...
							<input type="text" id="discount_name" name="discount_name" class="form-cto bor1px col-md-10" id="exampleInputName2" placeholder='<?php echo tpl_modifier_tr("请填写名称","org"); ?>'>
						</div>
						<div class='form-group coupon-form col-md-20 mb20'>
						...
						<div class="form-group coupon-form col-md-20 mb20">
							...
							<div class='cou-but'>
								<button id="submit" class=""><?php echo tpl_modifier_tr('创建','org'); ?></button>
