    ...
    <div class="right-main col-md-16 col-sm-16 bgf">
		...
		<?php if(SlightPHP\Tpl::$_tpl_vars["org"]->tmp_status==1){; ?>
			<div class="pos-abs status-tips cGray2">
				...
				<p class="p10">
				<a href="org.main.delCheckInfo?sk=tag" class="btn col-lg-3 col-lg-offset-8"><?php echo tpl_modifier_tr('点击查看','org'); ?></a>
				  </p>
			 </div>
		<?php }; ?>
		<?php if(SlightPHP\Tpl::$_tpl_vars["org"]->tmp_status==-1){; ?>
			<div class="pos-abs status-tips cGray2">
				...
				<p class="p10">
				<a href="org.main.info?act=edit" class="btn col-lg-3 col-lg-offset-8"><?php echo tpl_modifier_tr('重新提交资料','org'); ?></a>
				  </p>
			 </div>
		<?php }; ?>
            </div>
        ...
        <div class="content">
            ...
            <form id="info-form" class="form-horizontal">
                <div class="form-group col-md-20">
					...
					<label class='j-img'>
						<div id="panel" style="width:180px;height:48px;overflow:hidden;">
							<a class="institution" id="meg" <?php if(!empty(SlightPHP\Tpl::$_tpl_vars["org"]->thumb_big)){; ?>style='background:#f1f1f1;'<?php }; ?>>
								<p class="pd0"><?php echo tpl_modifier_tr('点击修改','org'); ?></p>
								<img id="img_p" class="info-logo-img" src="<?php if(!empty(SlightPHP\Tpl::$_tpl_vars["org"]->thumb_big)){; ?><?php echo utility_cdn::file(SlightPHP\Tpl::$_tpl_vars["org"]->thumb_big); ?><?php }else{; ?>/assets/images/jgt.jpg<?php }; ?>" alt="">
							</a>
							 ...
							 <input type="hidden" name="thumb_small" value="<?php echo SlightPHP\Tpl::$_tpl_vars["org"]->thumb_small; ?>" />
                    ...
                    <label class="absolite visible-lg"><p><?php echo tpl_modifier_tr('尺寸宽度180px，高度48px,支持jpg、png格式，图片小于3000KB','org'); ?></p></label>
                </div>
				<div class="form-group col-md-20">
                ...
                <div class="form-group col-md-20">
                    ...
                    <label class="absolite2 cGray visible-lg"><p><?php echo tpl_modifier_tr('便于页面展现,最大长度6个字','org'); ?></p></label>
                </div>
                <?php /*
				<div class="form-group col-md-20">
				...
				*/?>
                ...
                <div class="form-group col-md-20">
                    ...
                    <br>
                    <div class="clear"></div>
                    <textarea id="desc" name="desc" placeholder="请输入结构简介"  style="width:890px;height:270px;"><?php if(empty(SlightPHP\Tpl::$_tpl_vars["org"]->desc)){; ?><?php echo SlightPHP\Tpl::$_tpl_vars["org"]->desc; ?><?php }else{; ?><?php echo SlightPHP\Tpl::$_tpl_vars["org"]->desc; ?><?php }; ?></textarea>
                </div>
                <div class="form-group col-md-20 tac">
                    <button class="btn"><?php echo tpl_modifier_tr('提交审核','org'); ?></button>
                </div>
            </form>
        </div>
    </div>
...
<section id="upload-logo" style="display:none;">
    ...
    <div id="uploadIm_o">
        <img class="image-box" src="<?php if(!empty(SlightPHP\Tpl::$_tpl_vars["org"]->thumb_big)){; ?><?php echo utility_cdn::file(SlightPHP\Tpl::$_tpl_vars["org"]->thumb_big); ?><?php }else{; ?>/assets_v2/img/org-logo.png<?php }; ?>"/>
    </div>
    <p class="tac">
...
$(function(){
    $('#meg').on('click', function(){
		<?php if(!empty(SlightPHP\Tpl::$_tpl_vars["org"]->thumb_big)){; ?>
		$('#uploadImg').text('重新上传');
		$('#saveImg').show();
		$('#uploadIm_o').show();
		$('.upload-img').hide();
