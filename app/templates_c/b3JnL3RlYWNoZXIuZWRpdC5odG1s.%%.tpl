                    ...
                    <div class="content">
                        ...
                        <form  id="form">
                            <ul class="form-horizontal fs14">
								<li class="form-group">
                                    <div class="col-sm-4 col-md-4 col-xs-20 control-label fs14">
                                        <img src="<?php echo utility_cdn::img('/assets_v2/img/x.png'); ?>"><?php echo tpl_modifier_tr('角色','org'); ?>：
                                    </div>
                                    <div class="label-for col-sm-10 col-md-9 col-lg-9 col-xs-20">
										<label>
                                ...
                                <li class="form-group">
									<div class="col-sm-4 col-md-4 col-xs-20 control-label fs14"><img src="<?php echo utility_cdn::img('/assets_v2/img/x.png'); ?>"><?php echo tpl_modifier_tr('昵称','org'); ?>：</div>
								  <div class="label-for col-sm-10 col-md-9 col-lg-9 col-xs-20" >
								...
								<li class="form-group">
								  <div class="col-sm-4 col-md-4 col-xs-20 control-label fs14"><img src="<?php echo utility_cdn::img('/assets_v2/img/x.png'); ?>"> <?php echo tpl_modifier_tr('真实姓名','org'); ?>：</div>
								  <div class="label-for col-sm-10 col-md-9 col-lg-9 col-xs-20">
								...
								<li class="form-group">
									<div class="col-sm-4 col-md-4 col-xs-20 control-label fs14"><img src="<?php echo utility_cdn::img('/assets_v2/img/x.png'); ?>"> <?php echo tpl_modifier_tr('性别','org'); ?>：</div>
								  <div class="label-for col-sm-10 col-md-9 col-lg-9 col-xs-20">
								...
								<li class="form-group">
									<div class="col-sm-4 col-md-4 col-xs-20 control-label fs14"><img src="<?php echo utility_cdn::img('/assets_v2/img/x.png'); ?>"> <?php echo tpl_modifier_tr('常住地区','org'); ?>：</div>
								  <div class="label-for col-sm-10 col-md-9 col-lg-9 col-xs-20">
									<select name="region_level0" id="level0" class="col-sm-3 col-xs-4">
									  ...
									  <option <?php if(!empty(SlightPHP\Tpl::$_tpl_vars["userinfo"]->student->region_level0) && SlightPHP\Tpl::$_tpl_vars["userinfo"]->student->region_level0==SlightPHP\Tpl::$_tpl_vars["region"]->region_id){; ?> selected <?php }; ?> value="<?php echo SlightPHP\Tpl::$_tpl_vars["region"]->region_id; ?>"><?php echo SlightPHP\Tpl::$_tpl_vars["region"]->name; ?></option>
									  <?php }; ?>
									<?php }; ?>
									</select>
                                ...
                                <li class="form-group">
                                    ...
                                    <div class="label-for col-sm-16 col-md-16">
                                ...
                                <li class="form-group">
                                    <div class="col-sm-4 col-md-4 col-xs-20 control-label fs14"><?php echo tpl_modifier_tr('学历','org'); ?>：</div>
                                    <div class="label-for col-sm-16 col-xs-20 col-md-16">
                                ...
                                <li class="item_2 form-group">
                                    ...
                                    <div class="label-for col-xs-20 col-sm-15 col-md-16">
                                        <div class="dropdown col-xs-9" id="t-subj-content"  style="height:36px;padding:5px;border:1px solid #ccc;">
                                            ...
                                            <?php if(!empty(SlightPHP\Tpl::$_tpl_vars["v"]->name)){; ?><div class="delect-subj dropdown-show-tab c-fl" contenteditable="false">
                                        ...
                                        <div class="c-fl" style="line-height:26px;">&nbsp;&nbsp;<input id="click-but" type="button" value="<?php echo tpl_modifier_tr('添加标签','org'); ?>">&nbsp;
                                            <span class="cGray"><?php echo tpl_modifier_tr('至少选择一项，最多选择三项','org'); ?></span>
                                        </div>
                                        <div class="col-sm-9 t-subjects-list col-md-10 col-xs-20" id="t-subjects-list">
                                ...
                                <li class="form-group">
                                    <div class="control-label col-sm-4 col-md-4 col-xs-20">
                                        <img src="<?php echo utility_cdn::img('/assets_v2/img/x.png'); ?>">&nbsp;<?php echo tpl_modifier_tr('我的头衔','org'); ?>：
                                    </div>
                                    <div class="label-for col-sm-16 col-md-16 col-xs-20">
                                ...
                                <li class="form-group">
                                    <div class="control-label col-sm-4 col-md-4 col-xs-20"><?php echo tpl_modifier_tr('一句话简介','org'); ?>：</div>
                                    <div class="label-for col-sm-16 col-md-16 col-xs-20">
                                ...
                                <li class="form-group">
                                    ...
                                    <div class="label-for col-sm-16 col-md-16 col-xs-20">
                                        <textarea name="desc" id="desc" cols="30" style="height:200px;" rows="3" class="col-sm-12" placeholder=""><?php if(!empty(SlightPHP\Tpl::$_tpl_vars["teacher"]->desc)){; ?><?php echo SlightPHP\Tpl::$_tpl_vars["teacher"]->desc; ?><?php }; ?></textarea>
                                        <span class="cGray col-md-20"><?php echo tpl_modifier_tr('用一段话来介绍自己,让学生和家长更好的了解你,最多1000字','org'); ?>&nbsp;&nbsp;</span>
                                        <span class="tip1 cRed"></span>
                                    </div>
                                ...
                                <li class="form-group">
                                    ...
                                    <div class="label-for col-sm-9 col-md-16">
                                            <button class="col-sm-2 col-md-3 btn" type="submit"><?php echo tpl_modifier_tr('保存','org'); ?></button>
                                    </div>
                                </li>
                            </ul>
    ...
    oT_Div_List.on("click",function(){
        ...
        if($(this).hasClass("on")){
            ...
            if($('#t-subj-content>div').length>=3){
                ...
                $("#t-subj-content").append('<div class="delect-subj dropdown-show-tab pd0 c-fl"  contenteditable="false">'+$(this).text()+'<input type="hidden" name="good_subject[]" value="'+val+'"/></div>');
            }
        }
    })
...
$(function(){
	$('#real_name').blur(function(){
		...
		$('#real_name').removeClass('box-shadow');
		 ...
		 if(reg.test(real_name)){
		    if(real_name.length>10){
		    	$('.tip2').html("<?php echo tpl_modifier_tr('真实姓名不超过10个汉字','site.user'); ?>");
		        $('#real_name').addClass('box-shadow');
		        return;
		    }else{
		    	flag = 1;
		...
		var region_level0 = "<?php if(!empty(SlightPHP\Tpl::$_tpl_vars["userinfo"]->student->region_level0)){; ?><?php echo SlightPHP\Tpl::$_tpl_vars["userinfo"]->student->region_level0; ?><?php }; ?>";
		var region_level1 = "<?php if(!empty(SlightPHP\Tpl::$_tpl_vars["userinfo"]->student->region_level1)){; ?><?php echo SlightPHP\Tpl::$_tpl_vars["userinfo"]->student->region_level1; ?><?php }; ?>";
		var region_level2 = "<?php if(!empty(SlightPHP\Tpl::$_tpl_vars["userinfo"]->student->region_level2)){; ?><?php echo SlightPHP\Tpl::$_tpl_vars["userinfo"]->student->region_level2; ?><?php }; ?>";
		var school_id     = "<?php if(!empty(SlightPHP\Tpl::$_tpl_vars["userinfo"]->student->school_id)){; ?><?php echo SlightPHP\Tpl::$_tpl_vars["userinfo"]->student->school_id; ?><?php }; ?>";
		var school_type   = "<?php if(!empty(SlightPHP\Tpl::$_tpl_vars["userinfo"]->student->school_type)){; ?><?php echo SlightPHP\Tpl::$_tpl_vars["userinfo"]->student->school_type; ?><?php }; ?>";
		var school_grade  = "<?php if(!empty(SlightPHP\Tpl::$_tpl_vars["userinfo"]->student->grade)){; ?><?php echo SlightPHP\Tpl::$_tpl_vars["userinfo"]->student->grade; ?><?php }; ?>";
		if(school_type == 0){
			school_type = 1;
		}
