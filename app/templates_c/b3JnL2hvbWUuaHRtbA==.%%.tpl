            ...
            <div class="right-main col-md-16">
                ...
                <div class="col-md-7 org-profile mt15">
                    <div class="org-profile-content">
                        <p class="cDarkgray fs14 col-xs-20 pd0"><i class="income-icon"></i><span class="c-fl ml5 fb"><?php echo tpl_modifier_tr('累计收入','org'); ?>（元）</span></p>
                ...
                <div class="col-md-6 bank-card-profile mt15">
                    ...
                    <?php }elseif((SlightPHP\Tpl::$_tpl_vars["isAdmin"] == 1)){; ?>
                        <a class="bc-noinfo" href="/org.settle.bankcard" target="_blank"><span class="add-bc-icon c-fl"></span><span class="c-fl"><?php echo tpl_modifier_tr('添加银行卡','org'); ?></span></a>
                    ...
                    <ul class="org-timetable">
                        ...
                        <li class="col-md-10">
                            ...
                            <p class="col-md-10 c-info">
                                ...
                                <?php if(SlightPHP\Tpl::$_tpl_vars["td"]->type==1){; ?>
                    ...
                    <ul class="org-timetable" style="display:none">
                        ...
                        <li class="col-md-10">
                            ...
                            <p class="col-md-10 c-info">
                                ...
                                <?php if(SlightPHP\Tpl::$_tpl_vars["tt"]->type==1){; ?>
