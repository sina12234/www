            ...
            <script type="text/template" id="table-grid">
                <thead>
                    <tr>
                        ...
                        <td class="col-md-4 col-xs-10">讲师：<%= taskData.teacherName%></td>
...
<script>
    $(function () {
        ...
        if(type == 'noCorrect'){
            $.ajax('/task/commitTask/studentTaskDetail',{
                dataType:'json',
                type:'get',
                data:{
                ...
                success:function (data) {
                    ...
                    if(result.code == 200){
                        ...
                        //点击图片放大
                        $('#pt-work-detail').find('.img-box img').viewer({
                            url: 'data-original',
                        });
            ...
            $.ajax('/task/publishTask/taskShow',{
                dataType:'json',
                type:'get',
                data:{
                ...
                success:function (data) {
                    ...
                    if(result.code == 200){
                        ...
                        $('#show-work-detail').find('.img-box img').viewer({
                            url: 'data-original',
                        });
