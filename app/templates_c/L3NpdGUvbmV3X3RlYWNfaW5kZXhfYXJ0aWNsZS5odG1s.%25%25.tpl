...
<html>
<head>
<title><?php if(!empty(SlightPHP\Tpl::$_tpl_vars["info"]->real_name)){; ?><?php echo SlightPHP\Tpl::$_tpl_vars["info"]->real_name; ?><?php }; ?> - 文章资料 -云课 - 专业的在线直播教育学习平台 - 云课网 </title>
...
<article class="container mt40 mb40">
        ...
        <article class="atr_ml">
            <ul class="one_atr_ul">
                <li>
                    ...
                    <div class="atr_rel tec atr_li atr_liBtn" style="margin-bottom: 10px;"><a href="/index/teacherblog/publish/<?php echo SlightPHP\Tpl::$_tpl_vars["tid"]; ?>"><em class="icon_pic rel_icon"></em>发布文章</a> </div>
                    <?php }; ?>
                            ...
                            <?php if(!empty(SlightPHP\Tpl::$_tpl_vars["list"]->tagLists)){; ?>
                                <?php foreach(SlightPHP\Tpl::$_tpl_vars["list"]->tagLists->list as SlightPHP\Tpl::$_tpl_vars["tag"]){; ?>
                                    <li  class="length_sl <?php if(SlightPHP\Tpl::$_tpl_vars["tag"]->fk_tag == SlightPHP\Tpl::$_tpl_vars["tagId"] && SlightPHP\Tpl::$_tpl_vars["tag"]->tag_status){; ?>atr_li_on<?php }; ?>" >
                                        <i class="icon_pic icon_on "></i><a href="/index/teacherblog/article/<?php echo SlightPHP\Tpl::$_tpl_vars["tag"]->fk_user; ?>/<?php echo SlightPHP\Tpl::$_tpl_vars["tag"]->fk_tag; ?>"><?php echo SlightPHP\Tpl::$_tpl_vars["tag"]->name; ?>（<?php echo SlightPHP\Tpl::$_tpl_vars["tag"]->total; ?>）</a>
                                    </li>
                                <?php }; ?>
                            <?php }; ?>
                        </ul>
                ...
                <li id='draftBox' style="display: none;">
                    <div class="atr_li atr_liBtn  <?php if(SlightPHP\Tpl::$_tpl_vars["tagId"] === 'draft'){; ?>atr_li_on<?php }; ?>">
                        <a href="/index/teacherblog/article/<?php echo SlightPHP\Tpl::$_tpl_vars["tid"]; ?>/draft"><i class="icon_pic icon"></i>草稿箱</a>
                    </div>
                </li>
            </ul>
        </article>
    ...
    <div class="col-md-15 th_m_r">
        ...
        <ul class="techear-courselist th_mr_data">
            ...
            <li class="col-md-20 col-sm-20" dataId="<?php echo SlightPHP\Tpl::$_tpl_vars["v"]->pk_article; ?>">
                <a href="/index/teacherblog/ArticleDetail/<?php echo SlightPHP\Tpl::$_tpl_vars["tid"]; ?>/<?php echo SlightPHP\Tpl::$_tpl_vars["v"]->pk_article; ?>">
                    ...
                    <?php if(SlightPHP\Tpl::$_tpl_vars["v"]->thumb){; ?>
                        <span class="col-md-4 col-sm-4"><img src="<?php echo SlightPHP\Tpl::$_tpl_vars["v"]->thumb; ?>"></span>
                ...
                <div class="clearfix col-md-4 tec_oper editBox" style="display:none">
                    ...
                    <a href="/index/teacherblog/publish/<?php echo SlightPHP\Tpl::$_tpl_vars["tid"]; ?>/edit/<?php echo SlightPHP\Tpl::$_tpl_vars["v"]->pk_article; ?>">编辑&nbsp;丨</a>
                </div>
                <?php }; ?>
            </li>
            <?php }; ?>
        ...
        <?php }else{; ?>
        <!--没有时状态-->
        <div class="col-md-6 col-md-offset-2 mt20 tec pd45">
