...
<style type="text/css">
#org-teacher-list{ left:0;top:0;width:436px;display:none;position: static;overflow:hidden;}
</style>
<body>
							...
							<div class="col-md-15 dropdown">
								<div class="dropdown-input t-dropdown-input col-md-14 clearfix" id="teachers-content">
									<div class="col-md-18 p0">
										...
										<input type="text" disabled  class="col-md-5 bgf course-name teacher-name-ipt" placeholder="添加老师" />
									</div>
									<div class="t-teach-icon"></div>
								</div>
								<ul class="dropdown-cent update-dropdown-cent clearfix" id="org-teacher-list"></ul>
							</div>
						</label>
							...
							<div class="col-md-15 dropdown">
								<label>
									<div class="dropdown-input label-dropdown-input update-dropdown-input col-md-14 p0 clearfix">
										...
										<input type="text" class="col-md-5 course-name course-name-ipt" maxlength="10" placeholder="添加标签" />
									</div>
								</label>
     ...
     <div class="lc-so-name mt20">
 			<div class="search-frame ml40">
                 ...
                 <button class="search-box org-t-search-btn" id="subsearch" style="float:left;">
                     <span class="search-icon" style="margin: 0;" onclick="orgTeacher()"></span>
...
<script id="orgTeacherTpl" type="text/template">
	<<#teachers>>
		<li class="dropdown-cents" teacherId="<<teacherId>>">
			<img src="<<thumbMed>>" class="c-fl mr10 mt5" width="20" height="20" alt="" />
			<div class="tab-delete"></div>
			<<realName>>
		</li>
	<</teachers>>
