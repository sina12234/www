...
<section id="wrap-login" style="display:block;">
    <div class="login-bg">
        <div class="container">
            <div class="row">
                <div class="login-content pd0 col-sm-10 c-fr mr15 clearfix col-xs-19 col-md-6" style="float:right">
                    <ul class="login-content-btn fs14 clearfix">
                        <li class="col-sm-10 tec curr col-xs-10">账号登录</li>
                        <li class="col-sm-10 tec col-xs-10">验证码登录</li>
                    </ul>
                    <ul class="login-content-ct bor1px clearfix">
                        <li class="col-sm-20 mt20" style="display:block;">
                            <form novalidate action="/site.main.login" method="post" autocomplete="off" id="x_submit_form">
                                <div class="pos-rel col-sm-20 pd0 mb20 mobileNum col-xs-20">
                                    ...
                                    <div class="pos-rel col-sm-15 pd0 col-xs-13">
                        ...
                        <form id="smsForm" method="post" action="#" autocomplete="off">
                            <div class="pos-rel col-sm-20 pd0 mb20 col-xs-20">
                                ...
                                <div class="pos-rel col-sm-12 pd0 col-xs-13 col-md-15">
                            ...
                            <div class="col-sm-20 pd0 mb20 col-xs-20">
                                <div class="col-sm-14 pd0 pos-rel  col-xs-13">
                                    <input placeholder="<?php echo tpl_modifier_tr('请输入手机验证码','site.login'); ?>" type="text" name="smspassword" id="x_pass" autocomplete="off" class="bor1px col-sm-20 aassword-ipt  col-xs-20 iptFocusBlur" style="height:40px;"/>
                                </div>
...
$(function() {
    ...
    $(".areaCountryInfo-box").on("click" ,".areaCountryInfo" ,function() {
		var area = $(this).find('.areaCode').text();
    ...
    $("#x_submit_form").submit(function(){
        if($("#x_uname").val()=='' || $("#x_uname").val()=="<?php echo tpl_modifier_tr('手机号','site.login'); ?>"){
