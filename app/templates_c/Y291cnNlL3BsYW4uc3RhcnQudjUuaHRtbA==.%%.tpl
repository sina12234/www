...
<script src="<?php echo utility_cdn::js('/assets_v2/js/display_student.js'); ?>"></script>
...
var pyy;
    ...
    if(browser.versions.weixin){
        ...
        if(browser.versions.pad){
            ...
            var groups = <?php echo SlightPHP\Tpl::$_tpl_vars["groups"]; ?>;
			var message ;
...
<!-- left -->
    <div class="left-player" id="left-player">
		...
		<div id="students_display" class="scrollbox clearfix">
			<div class="order-filter">
                <?php if(count(SlightPHP\Tpl::$_tpl_vars["groups"])){; ?>
				<div class="divselect">
					<cite>
	...
	<div id="main" class="player-box pos-rel">
		...
		<div class="box" id="box">
			<?php if(SlightPHP\Tpl::$_tpl_vars["plan_info"]->plan_status=="finished" or SlightPHP\Tpl::$_tpl_vars["plan_info"]->plan_status=="living"){; ?>
			<div id="player"></div>
		...
		<div class="handle-area" id="handle-area">
			...
			<div class="h-a-start pos-rel" style="display:none">
				<div class="c pos-abs col-sm-7" id="start">
					...
					<?php }elseif( SlightPHP\Tpl::$_tpl_vars["plan_info"]->plan_status=="living"){; ?>
