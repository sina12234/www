...
<header class="usernav">
    <div class="container">
        <div class="row">
				...
				<div class="container">
					<div class="row">
						...
						<ul class="clearfix">
							...
							<?php }; ?>
							<?php }; ?>
                            <!--<li class="col-xs-5 pd0"><a href="/site.main.WoDownload" target="_blank">APP下载</a></li>-->
			...
			<!-- 搜索 -->
					<!--<div class="m-sub-seach hidden-xs" id="m-sub-seach">
			...
			<div class="seach-input col-xs-20 hidden-lg hidden-md">
                <form id="search_form_wo">
                <?php if(isset(SlightPHP\Tpl::$_tpl_vars["searchField"]) && !empty(SlightPHP\Tpl::$_tpl_vars["searchField"])){; ?>
                <input type="text" class="c-fl fs14 col-xs-17" autocomplete="off" name="search_field" maxlength="15" value="<?php echo SlightPHP\Tpl::$_tpl_vars["searchField"]; ?>" placeholder="课程名称，科目"/>
                <?php }else{; ?>
                <input type="text" class="c-fl fs14 col-xs-17" autocomplete="off" name="search_field" maxlength="15" placeholder="课程名称，科目"/>
                <?php }; ?>
            ...
            <!--nav-->
            <nav class="g-nav col-lg-8 col-md-10 col-xs-20 swiper-container3">
                <ul class="swiper-wrapper h100 pos-abs" id="headernav">
                  <?php if(SlightPHP\Tpl::$_tpl_vars["is_pro"]){; ?>
                    <?php echo tpl_function_part("/site/main/WoNav"); ?>
					<li class="swiper-slide"><a href="/course.list">全部课程</a></li>
                    <?php if(isset(SlightPHP\Tpl::$_tpl_vars["wonav"]) && !empty(SlightPHP\Tpl::$_tpl_vars["wonav"])){; ?>
                    <?php foreach(SlightPHP\Tpl::$_tpl_vars["wonav"] as SlightPHP\Tpl::$_tpl_vars["v"]){; ?>
                    <li class="swiper-slide <?php if(!empty(SlightPHP\Tpl::$_tpl_vars["subnav"])&&SlightPHP\Tpl::$_tpl_vars["subnav"]==SlightPHP\Tpl::$_tpl_vars["v"]->tips){; ?>curr<?php }; ?>" style="display:none;">
                  ...
                  <!--li class="swiper-slide"><a href="#">会员商城</a></li-->
					...
					<?php }; ?>
                  	<li class="swiper-slide <?php if(!empty(SlightPHP\Tpl::$_tpl_vars["flag"])&&SlightPHP\Tpl::$_tpl_vars["flag"]=='student'){; ?>curr<?php }; ?>">
...
$(function(){
	...
	$('.site').click(function(){
		var menulist_hide = $('.mobile-nav-one');
			if(menulist_hide.css('display')=='none'){
				menulist_hide.css('display','block')
			}else{
				menulist_hide.css('display','none')
