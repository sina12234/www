        <div class="user-left-menu pd0 col-md-4 hidden-xs hidden-sm">
			...
			<input type="hidden" value="<?php echo SlightPHP\Tpl::$_tpl_vars["isTeacher"]; ?>" name="IsTeacher"/>
			<input type="hidden" value="<?php echo SlightPHP\Tpl::$_tpl_vars["type"]; ?>" name="Type"/>
			<div class="user-info">
				...
				<?php if(!empty(SlightPHP\Tpl::$_tpl_vars["isTeacher"]) and (SlightPHP\Tpl::$_tpl_vars["type"]=='teacher' or SlightPHP\Tpl::$_tpl_vars["type"]=='default')){; ?>
				<div class="tac pt5 gift-flower">
					<span class="gift-flower-icon"></span>共<em id="gift-total-num">0</em>朵
				</div>
				<?php }; ?>
                <div class="name fs18">
			...
			<?php }; ?>
				...
				<ul class="left-menu">
					...
					<li class=' nav-menu-box ' >
						<a class="nav-menu <?php if(SlightPHP\Tpl::$_tpl_vars["css"]=='address'){; ?>active<?php }; ?>" href="/student.main.address/1">
							<span class="nav-icon nav-uploadPic"></span>
								<span class="nav-tag">
									<?php echo tpl_modifier_tr('收货地址','site.user'); ?>
								</span>
						</a>
					</li>
                ...
                <a href="/teacher.course.timetable2" class="c-fr orange-link" style="margin-top:20px">
