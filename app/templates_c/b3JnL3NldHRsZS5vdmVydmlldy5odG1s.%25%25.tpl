					...
					<form id="ftime" action="/org.settle" method="get">
						<div class="bc-path col-md-20 mt20 fs14">
							...
							<div class="time-picker">
								<input name="start" type="text" placeholder="2016/09/21"  id="time-picker" value="<?php echo SlightPHP\Tpl::$_tpl_vars["start"]; ?>">
                                <i class=" settle-arrow-icon settle-arrow-icon-left"  ></i>
                                <span style="margin-left: 12px;">至</span>
								<input name="end" type="text" placeholder="2016/09/22"  id="time-picker2" value="<?php echo SlightPHP\Tpl::$_tpl_vars["end"]; ?>">
