...
a.layui-layer-btn0{ background: #67b53d;height: 30px;padding: 0 10px; line-height: 28px;cursor: pointer;}
a.layui-layer-btn0:hover{ background: #61a93a;}
.layui-layer-btn a.layui-layer-btn1{ height: 30px; padding: 0 10px;line-height: 28px;cursor: pointer;border-radius: 3px;color: #666; background: #f5f5f5; border: 1px solid #dcdcdc;}
a.layui-layer-btn1:hover{ background: #ededed;}
 </style>
<body>
                ...
                <div class="gn-base-ct clearfix">
                    <section class="col-md-20 fs14">
                        <h1 class="base-title mb20">
							...
							> <a href="/org.course.SetDesc">课程封面</a>
							> 设置章节
                        </h1>
                        ...
                        <div class="set-course-content gn-base-ct set-more-course clearfix" style="border:1px solid #e8e8e8;">
                            ...
                            <span class="col-md-3 cBlue p5" id="addMoreCoursePlan" type="<?php echo SlightPHP\Tpl::$_tpl_vars["type"]; ?>" onclick="addMorseCoursePlan(this)">+批量添加课时</span>
                        </div>
                        <div class="tac mt40 mb40 p40">
                            <button class="gray-button" onclick="backHistoryGo()">上一步</button>
                            <button class="green-button" id="add-course-plan-btn" onclick="createPlanSuccess(this)">完成创建</button>
                        </div>
                    </section>
                </div>
            </div>
...
<input class="hidden" type="<?php echo SlightPHP\Tpl::$_tpl_vars["type"]; ?>" updateId="0" classId="<?php echo SlightPHP\Tpl::$_tpl_vars["classId"]; ?>" courseId="<?php echo SlightPHP\Tpl::$_tpl_vars["courseId"]; ?>" sorurl="<?php echo SlightPHP\Tpl::$_tpl_vars["sourceUrl"]; ?>" id="grobal-course" />
<input class="hidden" id="course-plan-class" classId="<?php echo SlightPHP\Tpl::$_tpl_vars["classId"]; ?>" />
