        ...
        <div class="row">
            ...
            <div class="right-main col-md-16">
              ...
              <div class="tab-main mt10">
                <div class="tab-hd">
                  <a class="tab-hd-opt curr"><?php echo tpl_modifier_tr('单个添加','org'); ?></a>
                  <a class="tab-hd-opt"><?php echo tpl_modifier_tr('批量添加','org'); ?></a>
                </div>
              </div>
              <!--form-->
                      ...
                      <form id="form-one" class="add-t-div-pd0">
                        <li class="form-group">
                            ...
                            <div class="label-for col-xs-10 col-sm-10 input-box">
                                <input type="text" class="col-xs-20 col-sm-12 verify-judge"   id="name" name="name">
                                <div class="tips col-xs-20 col-sm-8">
                                    <span class="tips-icon"></span>
                                    <span class="tips-text">请填写教师姓名</span>
                                </div>
                            </div>
                        </li>
                        <li class="form-group">
                        ...
                        <li class="form-group">
                            ...
                            <div class="col-sm-7 submit"><button class="btn" type="submit"><?php echo tpl_modifier_tr('添加','org'); ?></button></div>
                        </li>
                        </form>
                    </ul>
                    <!-- 批量添加 -->
                    <ul class="form-more">
                        <form id="form-more">
                            <li>
                                ...
                                <div class="col-md-7 tl-tips cgray">
                            ...
                            <li>
                                <div class="  fs14" style="text-align:left;">
                                    <?php /*<input name="role[]" type="checkbox" value="general" /><?php echo tpl_modifier_tr('普通老师','org'); ?>
                                    <input name="role[]" type="checkbox" value="assistant" />助教*/?>
                                </div>
                            </li>
                            <li>
                                <div class="col-md-10 row mt10"><button  class="btn" type="submit"><?php echo tpl_modifier_tr('添加','org'); ?></button></div>
                            </li>

                            <p class="form-more-import c-fl mt10"><a href="" id="batch_import"><?php echo tpl_modifier_tr('批量导入','org'); ?></a>  <b>|</b>  <a href="<?php echo utility_cdn::img('/assets_v2/教师批量导入模板.xlsx'); ?>"><?php echo tpl_modifier_tr('模版下载','org'); ?></a></p>
...
$("input[name='role[]']").each(function() {
    ...
    $('#name').on({
        blur:function () {
            ...
            if( !real_name ) {
                _realName.call(this,'error','教师姓名不能为空');
                return;
            }else{
                var reg = /^[\u4E00-\u9FA5]+$/;
                var eng_reg = /^[a-zA-Z]+$/;
                if(reg.test(real_name)){
                    if(real_name.length>10){
                        _realName.call(this,'error','教师姓名不超过10个汉字');
                        return;
                    }else{
                    ...
                    if(real_name.length>50){
                        _realName.call(this,'error','教师姓名不超过50个英文字符');
                        return;
                    }else{
                        _realName.call(this,'tip','');
                    }
                }else{
                    _realName.call(this,'error','教师姓名只能输入汉字或者英文字符');
                }
            }
        },
        focus:function () {
            if($(this).parent().hasClass('tip')){
                ...
                _judgeText="<?php echo tpl_modifier_tr('请填写教师姓名','site.user'); ?>";
            }
