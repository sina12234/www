<div class="left-div col-sm-4 col-xs-20 hidden-xs">
    ...
    <dl class="linkman">
        <div>
            ...
            <div class="linkman-set linkman-set-icon" id="my-mesages-set" style="display:none\9">
                <div class="mesages-set my-mesages-set bor1px" style="display:none\9">
                    <i class="rt-jiao"></i>
                ...
                <!-- 设置内容 -->
                <div class="wrap-lt-set mesages-set my-msg-category-set bor1px" style="display:none\9">
                    <i class="rt-jiao"></i>
