...
<section id="wrap-login">
    <div class="col-xs-20 pd0">
        <ul class="login-content-btn fs14 clearfix">
            <li class="col-xs-10 tec curr">账号密码登录</li>
            <li class="col-xs-10 tec">手机动态码登录</li>
        </ul>
        <ul class="login-content-ct clearfix">
            <li class="col-xs-20 mt20" style="display:block;">
                <form novalidate  method="post" autocomplete="off" id="login_form">
                    <div class="col-xs-20 pd0 mb15 mobileNum">
                    ...
                    <div class="col-xs-20 cRed mb10" style="display:block;"><?php if(!empty(SlightPHP\Tpl::$_tpl_vars["error2"])){; ?><?php echo SlightPHP\Tpl::$_tpl_vars["error2"]; ?><?php }; ?></div>
					...
					<div class="x_error_left cRed col-xs-20 mb10" style="display:block;"></div>
                    ...
                    <div class="col-xs-20 pd0 mb10">
                        <input class="col-xs-20 btn" type="submit" value="<?php echo tpl_modifier_tr('登录','site.login'); ?>" />
                    </div>
                    <div class="col-xs-20 pd0 mb10">
            ...
            <li class="col-xs-20 mt20">
                <form id="smsForm" method="post" action="#" autocomplete="off">
					...
					<div class="col-sm-20 pd0 mb15 col-xs-20">
                    ...
                    <div class="col-xs-20 pd0 mb15">
						...
						<div class="x_error_right cRed col-xs-20" style="display:block;"></div>
                    </div>
                    <div class="col-xs-20 pd0 mb10">
                        <label class="c-fl">
                            <input style="vertical-align: middle;" type="checkbox" name="forever"/> <?php echo tpl_modifier_tr('7日内免登录','site.login'); ?>
                    ...
                    <div class="col-xs-20 pd0 mb10">
                        <input class="col-xs-20 btn" id="mobileSmsLogin" type="submit" value="<?php echo tpl_modifier_tr('登录','site.login'); ?>" />
                    </div>
                    <div class="col-xs-20 pd0 mb10">
                        <span class="c-fl mr10 mt10 fs14">
                            <?php echo tpl_modifier_tr('其他方式登录','site.login'); ?>：
...
$(function  () {
	...
	$("#login_form").submit(function(){
            ...
            var xPassWord = $.trim($("#x_pass").val());
            if(userName == '' || userName == "手机号") {
                $(".x_error_left").html("<?php echo tpl_modifier_tr('请输入手机号','site.login'); ?>");
                return false;
            }
            if(xPassWord == '' || xPassWord == "密码") {
                $(".x_error_left").html("<?php echo tpl_modifier_tr('密码不能为空','site.login'); ?>");
                return false;
            }
            var url = "/layer.main.loginAjax/<?php echo SlightPHP\Tpl::$_tpl_vars["cid"]; ?>/<?php echo SlightPHP\Tpl::$_tpl_vars["classId"]; ?>/<?php echo SlightPHP\Tpl::$_tpl_vars["num"]; ?>/<?php echo SlightPHP\Tpl::$_tpl_vars["source"]; ?>/<?php echo SlightPHP\Tpl::$_tpl_vars["setId"]; ?>"
            <?php if(!empty(SlightPHP\Tpl::$_tpl_vars["resellOrgId"])){; ?>
                url += "/<?php echo SlightPHP\Tpl::$_tpl_vars["resellOrgId"]; ?>";
            <?php }elseif( !empty(SlightPHP\Tpl::$_tpl_vars["qudaoCode"])){; ?>

                url += "/<?php echo SlightPHP\Tpl::$_tpl_vars["qudaoCode"]; ?>";
            <?php }; ?>
            $.post(url,$("#login_form").serialize(),function(r){
                if (r.code == 0) {
                    ...
                    $.post("/course/pay/check", {
                                ...
                                resellOrgId:<?php echo SlightPHP\Tpl::$_tpl_vars["resellOrgId"]; ?>
                            }, function (r) {
                                layer.close(index);
                                if (r.code == 0) {
                                    ...
                                    parent.location.href = "/order.main.buy/course/<?php echo SlightPHP\Tpl::$_tpl_vars["cid"]; ?>/<?php echo SlightPHP\Tpl::$_tpl_vars["classId"]; ?>/"+resellOrgId+"";}else{
                                        parent.location.href = "/order.main.buy/course/<?php echo SlightPHP\Tpl::$_tpl_vars["cid"]; ?>/<?php echo SlightPHP\Tpl::$_tpl_vars["classId"]; ?>/<?php echo SlightPHP\Tpl::$_tpl_vars["qudaoCode"]; ?>";
                                    }
                                } else {
                    ...
                    var url = "/layer/main/AddUserAddressLayer/<?php echo SlightPHP\Tpl::$_tpl_vars["cid"]; ?>/<?php echo SlightPHP\Tpl::$_tpl_vars["classId"]; ?>/<?php echo SlightPHP\Tpl::$_tpl_vars["num"]; ?>/<?php echo SlightPHP\Tpl::$_tpl_vars["source"]; ?>/<?php echo SlightPHP\Tpl::$_tpl_vars["setId"]; ?>"
                    <?php if(!empty(SlightPHP\Tpl::$_tpl_vars["resellOrgId"])){; ?>
                        url += "/<?php echo SlightPHP\Tpl::$_tpl_vars["resellOrgId"]; ?>";
                        <?php }elseif( !empty(SlightPHP\Tpl::$_tpl_vars["qudaoCode"])){; ?>
