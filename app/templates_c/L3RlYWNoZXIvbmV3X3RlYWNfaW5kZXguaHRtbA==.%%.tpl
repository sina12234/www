    ...
    <div class="col-md-5 th_m_l mt20">
        ...
        <article class="mt20 c-fl col-xs-20">
	        ...
	        <font style="display: none"><?php if(!empty(SlightPHP\Tpl::$_tpl_vars["info"]->avg_score)){; ?><?php echo SlightPHP\Tpl::$_tpl_vars["info"]->avg_score*20; ?><?php }else{; ?>00<?php }; ?>%</font>
                <span class="score"><?php echo SlightPHP\Tpl::$_tpl_vars["teach_score"]; ?>分</span>
                <div class="eval_pl col-md-20">
                    <span class="col-md-10" style="border-right:1px solid #e9e9e9;">综合得分<em><?php echo SlightPHP\Tpl::$_tpl_vars["teach_score"]; ?></em>分</span>
                    <span class="col-md-10">评价数<em><?php echo SlightPHP\Tpl::$_tpl_vars["total_user"]; ?></em>条</span>
                </div>
            </div>
        </article>
    </div>
            ...
            <?php if(!empty(SlightPHP\Tpl::$_tpl_vars["courseList"])){; ?>
                ...
                <?php foreach(SlightPHP\Tpl::$_tpl_vars["courseList"] as SlightPHP\Tpl::$_tpl_vars["v"]){; ?>
                    <li class="col-md-5 col-xs-10">
                        <div class="pic">
                            <a href="//<?php echo SlightPHP\Tpl::$_tpl_vars["v"]['domain']; ?>/course/info/show/<?php echo SlightPHP\Tpl::$_tpl_vars["v"]['course_id']; ?>"><img class="imgPic img-responsive" src="<?php echo SlightPHP\Tpl::$_tpl_vars["v"]['thumb']; ?>">
                        ...
                        <div>
                            <span class="fl col-md-16 row length_sl  fs12">
                               ...
                               <span class="c_a3"> &nbsp;|&nbsp;<?php echo SlightPHP\Tpl::$_tpl_vars["v"]['org_subname']; ?></span>
                            </span>
