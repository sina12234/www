...
class user_menu{
    ...
    public function create($type){
        if($type=='teacher'){
            $teacher = SConfig::getConfig(ROOT_CONFIG."/menu.conf","teacher");
            $menu=$teacher->menu;
        }else if($type=='student'){
            $student = SConfig::getConfig(ROOT_CONFIG."/menu.conf","student");
            $menu=$student->menu;
        }else{
            $default = SConfig::getConfig(ROOT_CONFIG."/menu.conf","default");
            $menu=$default->menu;
        }
